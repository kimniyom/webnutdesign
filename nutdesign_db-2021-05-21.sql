...
CREATE TABLE `account` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=110 DEFAULT CHARSET=utf8 COMMENT='ตารางแผนกบัญชี';
...
INSERT INTO `account` VALUES ('103', null, 'N84zvp2EMGIVn0hjgkMIey', null, null, '1', null, '1', '0', '2021-05-20 15:19:27', '2021-05-20 15:19:27', '<p>-</p>', null);
...
INSERT INTO `account` VALUES ('107', null, 'fsTTQ7vstSByNncnJZoCxK', null, null, '1', null, '1', '0', '2021-05-20 15:17:07', '2021-05-20 15:17:07', '<p><a href=\"https://doc-api.flowaccount.com/quotation/share/html/th/o6f7w7cm4ujzowtkfha9w\" target=\"_blank\" rel=\"noopener\">https://doc-api.flowaccount.com/quotation/share/html/th/o6f7w7cm4ujzowtkfha9w</a></p>', null);
INSERT INTO `account` VALUES ('108', null, '0Tn4Q_0bCtEWP5aEzzgogW', null, null, null, null, '0', '0', null, null, null, null);
INSERT INTO `account` VALUES ('109', null, 'YYJ3v_hmOBiElGpMyOGLNB', null, null, null, null, '2', '0', null, '2021-05-21 08:58:15', null, null);
...
CREATE TABLE `branchfacture` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=utf8 COMMENT='งานผลิตทั่วไป';
...
INSERT INTO `branchfacture` VALUES ('41', 'fsTTQ7vstSByNncnJZoCxK', '15', '4', '0', '2021-05-20 11:53:28', '2021-05-21 08:50:42', '');
INSERT INTO `branchfacture` VALUES ('42', 'H28fEkhWy3FxaUt4kvIvWb', null, '1', '0', null, null, null);
INSERT INTO `branchfacture` VALUES ('43', 'o-ySwjoOAuPPCkM5vP0HwB', null, '1', '0', null, null, null);
INSERT INTO `branchfacture` VALUES ('44', '5ldsZsOZWHoCYCyWUmNZbZ', null, '1', '0', null, null, null);
INSERT INTO `branchfacture` VALUES ('45', '8fqyNkmvDz-KnrxIAhlqpq', '15', '4', '0', '2021-05-21 09:05:31', '2021-05-21 09:05:39', '');
INSERT INTO `branchfacture` VALUES ('46', 'RjrS4s7oMr_ee2WLAKBJzO', '15', '4', '0', '2021-05-21 08:53:45', '2021-05-21 09:04:39', '');
INSERT INTO `branchfacture` VALUES ('47', 'MqajoS1HfT_sxkz6i3JL_G', null, '1', '0', null, null, null);
INSERT INTO `branchfacture` VALUES ('48', '4K8kx-HFGqvMAId3uOB-jz', '15', '4', '0', '2021-05-21 13:20:11', '2021-05-21 13:20:13', '');
...
CREATE TABLE `branchlaser` (
  ...
  `comment` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8 COMMENT='งาน laser';
...
INSERT INTO `branchlaser` VALUES ('33', 'fsTTQ7vstSByNncnJZoCxK', null, '1', '0', null, null, null);
INSERT INTO `branchlaser` VALUES ('34', '806u6W7JFbCMXVkF4LIr0G', '14', '2', '0', '2021-05-20 12:16:34', '2021-05-20 12:16:54', '');
INSERT INTO `branchlaser` VALUES ('35', 'qq6UhrH2J_97aT8-qTgJSl', '14', '4', '0', '2021-05-20 13:36:27', '2021-05-20 13:36:32', '');
INSERT INTO `branchlaser` VALUES ('36', 'MZj6PndvG7ZpAROePYv3hw', null, '1', '0', null, null, null);
INSERT INTO `branchlaser` VALUES ('37', 'yO2fo8ixzYbacmJat6prjK', null, '1', '0', null, null, null);
INSERT INTO `branchlaser` VALUES ('38', '8fqyNkmvDz-KnrxIAhlqpq', '17', '4', '0', '2021-05-21 10:29:40', '2021-05-21 10:29:44', '');
INSERT INTO `branchlaser` VALUES ('39', 'RjrS4s7oMr_ee2WLAKBJzO', null, '1', '0', null, null, null);
INSERT INTO `branchlaser` VALUES ('40', '6CLqIFoYZ84CDamOFl4bEw', null, '1', '0', null, null, null);
INSERT INTO `branchlaser` VALUES ('41', 'ywleq_CPImHyHkSdrQIjPm', null, '1', '0', null, null, null);
INSERT INTO `branchlaser` VALUES ('42', '4K8kx-HFGqvMAId3uOB-jz', null, '1', '0', null, null, null);
...
CREATE TABLE `branchmarketing` (
  ...
  `confirm_date` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='การตลาด';
...
INSERT INTO `branchmarketing` VALUES ('4', 'MqajoS1HfT_sxkz6i3JL_G', null, '1', '0', null, null);
...
CREATE TABLE `branchprint` (
  ...
  `comment` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=67 DEFAULT CHARSET=utf8 COMMENT='งานพิมพ์';
...
INSERT INTO `branchprint` VALUES ('59', 'fsTTQ7vstSByNncnJZoCxK', '13', '4', '0', '2021-05-20 11:50:51', '2021-05-20 15:32:31', 'เสร็จแล้วครับอยู่ในห้องประชุม');
INSERT INTO `branchprint` VALUES ('60', 'H28fEkhWy3FxaUt4kvIvWb', null, '1', '0', null, null, null);
INSERT INTO `branchprint` VALUES ('61', 'o-ySwjoOAuPPCkM5vP0HwB', null, '1', '0', null, null, null);
INSERT INTO `branchprint` VALUES ('62', '5ldsZsOZWHoCYCyWUmNZbZ', null, '1', '0', null, null, null);
INSERT INTO `branchprint` VALUES ('63', '806u6W7JFbCMXVkF4LIr0G', '13', '2', '0', '2021-05-21 08:23:33', '2021-05-21 08:23:55', 'เสร็จแล้วครับ');
INSERT INTO `branchprint` VALUES ('64', '8fqyNkmvDz-KnrxIAhlqpq', '13', '4', '0', '2021-05-20 15:40:03', '2021-05-21 08:23:58', 'เสร็จแล้วครับ');
INSERT INTO `branchprint` VALUES ('65', 'MqajoS1HfT_sxkz6i3JL_G', null, '1', '0', null, null, null);
INSERT INTO `branchprint` VALUES ('66', 'ywleq_CPImHyHkSdrQIjPm', null, '1', '0', null, null, null);
...
CREATE TABLE `customer` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=126 DEFAULT CHARSET=utf8 COMMENT='เก็บรายละเอียดลูกค้า / รับงาน';
...
INSERT INTO `customer` VALUES ('98', 'ติดตั้งงาน ', 'Yu ยู้แอนด์ยู คลินิก', '0000000000', '1', null, 'Yu ยู้แอนด์ยู คลินิก', '-', null, '<p>ติดตั้งงาน </p>', null, '2021-05-18', '09:26:00', '3, 4', null, '2021-05-18 09:32:44', '8', '3qfWzNL0gNGXQjOCaR6YTi', '0', '1', '1', '1', '0', '1', '0', null, null, '2', '0', '0', '2', '1', '1', '2021-05-20 15:17:46', '', '5', '1', null);
...
INSERT INTO `customer` VALUES ('112', 'ไวนิล', 'ตากขาวละออ', '', '1', null, 'ตากขาวละออ', 'รับงานหน้าร้านวันศุกร์ 21/05/64 ', null, '<p>ไวนิล 300x200 ซม. 1 ผืนๆละ 960.-<br>แจ้งรับงานวันศุกร์ 21/05/64</p><p><br></p><p>พับขอบ ไม่ตอกตาไก่<br></p>', null, '2021-05-19', '11:00:00', '3, 4', null, '2021-05-19 16:00:47', '8', 'd54MvCz6fsOTye6WQpOq8v', '1', '0', '0', '1', '1', '1', '0', null, null, '0', '0', '0', '0', '1', null, '2021-05-20 15:18:48', '', '3', '1', null);
INSERT INTO `customer` VALUES ('113', 'ป้ายพลาสวูดพร้อมเสาเหล็ก', 'Aree', '084-1410478 , 02-1062328', '1', 'Aree', '', 'นิติบุคคลอาคารชุด ศุภาลัย โอเรียนทัล สุขุมวิท 39\r\n199 และ 1991-1055 ซอยสุขุมวิท 39 (พร้อมพงษ์)แขวงคลองตันเหนือ เขตวัฒนา กรุงเทพมหานคร 10110\r\nโทร: 084-1410478,02-1062328', null, '<p>ป้ายพลาสวูดพิมพ์ยูวีขนาด 30x17 ซม. เสาเหล็ก 5ชิ้นๆละ 520.-<br><br>ส่วนลด 100.-</p><p>ใบกำกับภาษี INV2021050083 <a href=\"https://doc-api.flowaccount.com/taxinvoice/share/html/th/0bvmlb7vkc4rauqu3lcw?Invoice=0&amp;InvoiceCopy=0&amp;IsIncludePaymentDetail=0&amp;TaxInvoice=1&amp;TaxInvoiceCopy=0\" target=\"_blank\">https://doc-api.flowaccount.com/taxinvoice/share/html/th/0bvmlb7vkc4rauqu3lcw?Invoice=0&amp;InvoiceCopy=0&amp;IsIncludePaymentDetail=0&amp;TaxInvoice=1&amp;TaxInvoiceCopy=0</a><br>ใบเสร็จรับเงิน RE2021050080 <a href=\"https://doc-api.flowaccount.com/receipt/share/html/th/hfwcebif90mqjcebfbxbq?DoCopies=0&amp;DoOriginal=1&amp;InvoiceCopy=0&amp;IsIncludePaymentDetail=0&amp;TaxInvoiceCopy=0\" target=\"_blank\" rel=\"noopener\">https://doc-api.flowaccount.com/receipt/share/html/th/hfwcebif90mqjcebfbxbq?DoCopies=0&amp;DoOriginal=1&amp;InvoiceCopy=0&amp;IsIncludePaymentDetail=0&amp;TaxInvoiceCopy=0</a><span class=\"redactor-invisible-space\"></span></p>', null, '2021-05-20', '14:00:00', '3, 5, 6, 7', null, '2021-05-20 11:17:37', '8', 'fsTTQ7vstSByNncnJZoCxK', '1', '0', '0', '0', '1', '1', '0', null, null, '2', '0', '2', '0', '0', null, null, null, '5', '3', '2');
INSERT INTO `customer` VALUES ('114', '​สติ๊กเกอร์สีทองพิมพ์ยูวี', 'Pradit', '099-2649528', '1', 'Pradit', '', '-', null, '<p>สติ๊กเกอร์สีทองพิมพ์ยูวี ขนาด 7.8 ซม. 1 ชิ้น ราคา 300.-</p>', null, '2021-05-20', '11:33:00', '3, 5, 7', null, '2021-05-20 11:34:12', '8', 'H28fEkhWy3FxaUt4kvIvWb', '0', '0', '0', '0', '0', '1', '0', null, null, '0', '0', '0', '0', '0', null, null, null, '3', '3', '4');
INSERT INTO `customer` VALUES ('115', 'surfskate ', 'ลูกค้าพี่ณัฐ', '', '3', '', '', '-', null, '<p>-</p>', null, '2021-05-20', '11:56:00', '5, 6', null, '2021-05-20 11:59:05', '8', '806u6W7JFbCMXVkF4LIr0G', '0', '0', '0', '2', '0', '1', '0', '1', '', '2', '2', '0', '0', '0', null, null, null, '5', '1', '4');
INSERT INTO `customer` VALUES ('116', 'ตัดไม้เลข 9 ', 'ลูกค้าพี่ณัฐ', '', '3', '', '', '-', null, '', null, '2021-05-20', '11:59:00', '6', null, '2021-05-20 12:00:48', '8', 'qq6UhrH2J_97aT8-qTgJSl', '0', '0', '0', '0', '0', '1', '0', null, null, '0', '2', '0', '0', '0', null, null, null, '5', '1', '4');
INSERT INTO `customer` VALUES ('117', 'ตัดอักษรอะคริลิค ', 'Meena', '', '3', '', '', '-', null, '<p>เลข 3 , 4  <br>* พี่ณัฐสั่งตัดให้แล้ว <br><br></p>', null, '2021-05-20', '13:46:00', '6', null, '2021-05-20 13:48:20', '8', 'yO2fo8ixzYbacmJat6prjK', '0', '0', '0', '1', '0', '1', '0', null, null, '0', '0', '0', '0', '1', '1', '2021-05-20 15:17:26', '', '5', '3', '4');
INSERT INTO `customer` VALUES ('118', 'surfskate', 'One1', '', '1', 'One1', '', '-', null, '<p>surfskate ข้อความว่า hangover<br><br>*พี่ณัฐดูแลงานออกแบบให้ <span class=\"redactor-invisible-space\"></span></p>', null, '2021-05-21', '10:00:00', '3, 5, 6, 7', null, '2021-05-20 14:05:31', '8', '8fqyNkmvDz-KnrxIAhlqpq', '0', '0', '0', '0', '0', '1', '0', null, null, '2', '2', '2', '0', '0', null, null, null, '5', '1', '4');
INSERT INTO `customer` VALUES ('119', 'บล็อคพ่นสี', 'yai', '0851003160', '1', 'yai', '', 'ร้านทำทุกอย่างดอทคอม  \r\nK เข้ม 0851003160\r\n\r\nเลขตึก  162/532  บางแคคอนโดทาวน  \r\nห้อง 168 อาคารพาณิชย์  ก่อนถึงศาลพระภูมิ  \r\nถ.เพชรเกษม   แขวงบางแคเหนือ เขตบางแค  กรุงเทพ 10160', null, '<p>บล็อคพ่นสี ขนาด 45x16 ซม. 1 ชิ้นๆละ 160.- รวมจัดส่ง<br>*ข้อมูลอยู่ในเมล์<br>*งานแก้ไข</p>', null, '2021-05-20', '11:30:00', '3, 6, 7', null, '2021-05-20 14:36:09', '8', 'RjrS4s7oMr_ee2WLAKBJzO', '1', '0', '0', '0', '0', '1', '0', null, null, '0', '0', '2', '0', '0', null, null, null, '5', '3', '4');
INSERT INTO `customer` VALUES ('120', '​คอมโพสิตลายไม้ตัดอักษร', 'น้ำฝน  มั่นคง', '087-3101779', '1', 'น้ำฝน  มั่นคง', '', '-', null, '<p>คอมโพสิตลายไม้ตัดอักษร ๔๒ อย่างละ 1 ชิ้น ราคารวม 300.-</p>', null, '2021-05-20', '15:30:00', '6', null, '2021-05-20 15:01:04', '8', '6CLqIFoYZ84CDamOFl4bEw', '0', '0', '0', '1', '0', '1', '0', null, null, '0', '0', '0', '0', '1', null, '2021-05-20 15:18:16', '', '5', '3', '4');
INSERT INTO `customer` VALUES ('121', 'ป้ายไวนิล+สติ๊กเกอร์ติดรถ', 'พี่เจี๊ยบ สสจ.ตาก', '-', '1', 'พี่เจี๊ยบ สสจ.ตาก', '', 'สสจ.ตาก', null, '<p>ป้ายไวนิล 3X1 เมตร จำนวน 1 ป้าย ข้อความดังนี้<br><br>ชาวจังหวัดตาก ร่วมกำลังใจให้นักรบชุดขาวจังหวัดตากเดินทางร่วมใจช่วยภัยโควิด 19<br>ปฏิบัติงานในศูนย์แรกรับผู้ติดเชื้อโควิด 19 (Pre Admission Center) อาคารกีฬานิมิบุตร กรุงเทพมหานคร<br><br>ใส่รูปคนที่ไปในป้ายด้วยจ้า **ไฟล์ลูกค้าส่งไว้ในไลน์**</p><p>--------------------------------------------</p><p>sticker ติดรถตู้ อีก 2 อัน ติดข้างรถตู้จ้า<br><br>นักรบชุดขาวจังหวัดตากเดินทางร่วมใจช่วยภัยโควิด 19<br>ปฏิบัติงานในศูนย์แรกรับผู้ติดเชื้อโควิด 19 (Pre Admission Center) อาคารกีฬานิมิบุตร กรุงเทพมหานคร</p><p><br></p>', null, '2021-05-24', '10:00:00', '3', null, '2021-05-20 15:01:39', '8', '0Tn4Q_0bCtEWP5aEzzgogW', '0', '0', '0', '0', '1', '1', '0', null, null, '0', '0', '0', '0', '0', null, null, null, '4', '1', '3');
INSERT INTO `customer` VALUES ('123', 'ไวนิล', '', '084-3597162', '1', '', '', 'คุณหทัยทิพย์ ประเสริฐภิญโญ\r\nหอพักสุขสบาย ตึก 1 ห้อง 407 เลขที่ 52/245 หมู่บ้านเมืองเอก ต.หลักหก อ.เมืองปทุมธานี จ.ปทุมธานี 12000\r\nโทร. 084-359-7162', null, '<p>ไวนิล 300x150 ซม. 1 ผืนๆละ 800.-<br>ค่าจัดส่ง 150.-<br><br>ยอดชำระรวม 950.- </p><p>*พับขอบตอกไก่ <br><br>ส่ง 22/05/64</p>', null, '2021-05-22', '12:30:00', '3, 5, 7', null, '2021-05-21 08:32:47', '8', 'MqajoS1HfT_sxkz6i3JL_G', '1', '0', '0', '0', '0', '1', '0', null, null, '0', '0', '0', '0', '0', null, null, null, '5', '3', '4');
INSERT INTO `customer` VALUES ('124', 'คอมโพสิตลายไม้พิมพ์ยูวี', 'น้ำฝน  มั่นคง', '087-3101779', '1', 'น้ำฝน  มั่นคง', '', '', null, '<p>ป้ายบ้านเลขที่</p><p>คอมโพสิตลายไม้พิมพ์ยูวี ตัวอักษรสีขาว ขนาดป้าย 22X18 ซม. เจาะรู 4 มุม จำนวน 1 ป้าย <br>ราคา 450 บาท</p><p>* เลข ๔๒ สีขาว </p><p><br>** ลูกค้าชำระ 20/5/2564 แล้ว 300 บาท **<br>ค้างชำระ 150 บาทค่ะ</p>', null, '2021-05-21', '15:00:00', '3, 5, 6', null, '2021-05-21 09:02:17', '8', 'ywleq_CPImHyHkSdrQIjPm', '0', '0', '0', '0', '0', '1', '0', null, null, '0', '0', '0', '0', '0', null, null, null, '3', '2', '4');
INSERT INTO `customer` VALUES ('125', 'บล็อคอะคริลิคพ่นสี', 'Rosie', '0959879951', '1', 'Rosie', '', 'คุณรสสุคนธ์ ธรรมรส\r\n246/149 หมู่ 6 ตำบลหนองจ๊อม\r\nอำเภอสันทราย จังหวัดเชียงใหม่\r\n50210\r\n0959879951', null, '<p>แบบ B บล็อคอะคริลิคพ่นสี 3 มิล ขนาด 12x8.7 ซม. พร้อมด้ามจับ 10 ซม. 3 ชิ้นๆละ 150.- จัดส่งฟรี<br><br>-------------- ยอดชำระทั้งสิ้น 450 บาทค่ะ -----------------<br></p><p>ใบเสนอราคา QT2021050100</p>', null, '2021-05-21', '11:30:00', '3, 6, 7', null, '2021-05-21 09:17:11', '8', '4K8kx-HFGqvMAId3uOB-jz', '1', '0', '0', '0', '0', '1', '0', null, null, '0', '0', '2', '0', '0', null, null, null, '4', '3', '2');
...
CREATE TABLE `graphic` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=123 DEFAULT CHARSET=utf8 COMMENT='ตารางแผนกกราฟิก';
...
INSERT INTO `graphic` VALUES ('91', 'MZj6PndvG7ZpAROePYv3hw', null, '<p>ตัด pw 10 mm</p>', '', 'wzUSudWdIi7GO_F0th1k0u', '17', null, '1', '1', '2021-05-20 13:47:26', '2021-05-20 13:47:30', '2', '6');
...
INSERT INTO `graphic` VALUES ('108', 'o-ySwjoOAuPPCkM5vP0HwB', null, '', '', 'RinSJgLJcssu-JCWY9yBMK', '12', null, '1', '1', '2021-05-20 11:56:08', '2021-05-20 11:56:11', '2', '5, 7');
INSERT INTO `graphic` VALUES ('109', '5ldsZsOZWHoCYCyWUmNZbZ', null, '', '', 'MvDLdRwelWQmyu3Qc5EjSj', '12', null, '1', '1', '2021-05-20 11:58:42', '2021-05-20 11:58:46', '2', '5, 7');
...
INSERT INTO `graphic` VALUES ('114', 'fsTTQ7vstSByNncnJZoCxK', null, '', '', 'aJcaTmZe7jSo2pVBHwKqVW', '12', null, '1', '1', '2021-05-20 13:39:01', '2021-05-20 13:39:04', '2', '5, 6');
INSERT INTO `graphic` VALUES ('115', 'H28fEkhWy3FxaUt4kvIvWb', null, null, '', '', null, null, '0', '0', null, null, '1', null);
INSERT INTO `graphic` VALUES ('116', '8fqyNkmvDz-KnrxIAhlqpq', null, '<p>ตัด al laser</p><p><br></p>', '', 'CrO9CgnH7luAsFp5_UfrA9', '17', null, '1', '1', '2021-05-20 14:52:26', '2021-05-20 14:52:30', '2', '5, 6');
INSERT INTO `graphic` VALUES ('117', 'RjrS4s7oMr_ee2WLAKBJzO', null, '', '', 'hzNd6GVhLfXg5CcvIvz1lW', '12', null, '1', '1', '2021-05-21 09:42:44', '2021-05-21 09:42:46', '2', '6, 7');
INSERT INTO `graphic` VALUES ('118', '0Tn4Q_0bCtEWP5aEzzgogW', null, null, '', '', null, null, '0', '0', null, null, '1', null);
INSERT INTO `graphic` VALUES ('119', 'YYJ3v_hmOBiElGpMyOGLNB', null, null, '', '', null, null, '2', '0', null, '2021-05-21 08:58:15', '1', null);
INSERT INTO `graphic` VALUES ('120', 'MqajoS1HfT_sxkz6i3JL_G', null, '', '', 'XwPj_BKECzWeNS4B8soJIG', '1', null, '0', '0', '2021-05-21 08:58:57', '2021-05-21 09:15:19', '1', null);
INSERT INTO `graphic` VALUES ('121', 'ywleq_CPImHyHkSdrQIjPm', null, null, '', '', null, null, '0', '0', null, null, '1', null);
INSERT INTO `graphic` VALUES ('122', '4K8kx-HFGqvMAId3uOB-jz', null, '', '', 'WjMYt_T2Zp4zOXkiL4BPzO', '12', null, '1', '1', '2021-05-21 09:43:22', '2021-05-21 09:43:25', '2', '6, 7');
...
CREATE TABLE `queue` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COMMENT='ตารางคิวงานติดตั้ง ส่งมาเมื่อกราฟฟิกบันทึกข้อมูล';
...
INSERT INTO `queue` VALUES ('23', '3qfWzNL0gNGXQjOCaR6YTi', '8', '2021-05-18', '15:00:00', '2', '1', '2021-05-20 10:07:00', '17', '', 'ld6RQfm-wZvqmh60GIycBh');
INSERT INTO `queue` VALUES ('24', 'MZj6PndvG7ZpAROePYv3hw', null, null, null, '0', '0', null, null, null, null);
...
CREATE TABLE `rule` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=93 DEFAULT CHARSET=utf8 COMMENT='สิทธิ์การเข้าถึงแผนก';
...
INSERT INTO `rule` VALUES ('90', '13', '16', '1');
INSERT INTO `rule` VALUES ('91', '14', '16', '1');
INSERT INTO `rule` VALUES ('92', '13', '8', '1');
...
CREATE TABLE `timeline` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=830 DEFAULT CHARSET=utf8 COMMENT='ตารางเก็บประวัติการทำงาน';
...
INSERT INTO `timeline` VALUES ('767', null, 'pdci6GgdMe4wBztYRnGZsv', '12', '1', 'ส่งมอบงานลูกค้า', '2021-05-20 09:46:45', 'ส่งมอบงานลูกค้า', '0');
INSERT INTO `timeline` VALUES ('768', null, '3qfWzNL0gNGXQjOCaR6YTi', '12', '1', 'ส่งมอบงานลูกค้า', '2021-05-20 09:46:52', 'ส่งมอบงานลูกค้า', '0');
INSERT INTO `timeline` VALUES ('769', null, '3qfWzNL0gNGXQjOCaR6YTi', '8', '17', 'รับงาน', '2021-05-20 10:06:54', 'ช่างติดตั้ง(รับงาน)', '0');
INSERT INTO `timeline` VALUES ('770', null, '3qfWzNL0gNGXQjOCaR6YTi', '8', '17', 'ติดตั้งงานลูกค้า', '2021-05-20 10:07:00', 'ช่างติดตั้ง(ส่งงานลูกค้า)', '0');
INSERT INTO `timeline` VALUES ('771', null, 'fsTTQ7vstSByNncnJZoCxK', '1', '8', 'บันทึกข้อมูลการรับงาน', '2021-05-20 11:17:37', 'กราฟิก,งานพิมพ์,CNC / Laser,ผลิตทั่วไป', '0');
INSERT INTO `timeline` VALUES ('772', null, 'H28fEkhWy3FxaUt4kvIvWb', '1', '8', 'บันทึกข้อมูลการรับงาน', '2021-05-20 11:34:12', 'กราฟิก,งานพิมพ์,ผลิตทั่วไป', '0');
INSERT INTO `timeline` VALUES ('773', null, 'fsTTQ7vstSByNncnJZoCxK', '5', '13', 'รับงาน', '2021-05-20 11:50:51', 'งานพิมพ์(รับงาน)', '0');
INSERT INTO `timeline` VALUES ('774', null, 'fsTTQ7vstSByNncnJZoCxK', '7', '15', 'รับงาน', '2021-05-20 11:53:28', 'ผลิตทั่วไป(รับงาน)', '0');
INSERT INTO `timeline` VALUES ('775', null, 'o-ySwjoOAuPPCkM5vP0HwB', '3', '12', 'สั่งผลิต', '2021-05-20 11:56:08', 'งานพิมพ์,ผลิตทั่วไป', '0');
INSERT INTO `timeline` VALUES ('776', null, '5ldsZsOZWHoCYCyWUmNZbZ', '3', '12', 'สั่งผลิต', '2021-05-20 11:58:42', 'งานพิมพ์,ผลิตทั่วไป', '0');
INSERT INTO `timeline` VALUES ('777', null, '806u6W7JFbCMXVkF4LIr0G', '1', '8', 'บันทึกข้อมูลการรับงาน', '2021-05-20 11:59:05', 'งานพิมพ์,CNC / Laser', '0');
INSERT INTO `timeline` VALUES ('778', null, 'qq6UhrH2J_97aT8-qTgJSl', '1', '8', 'บันทึกข้อมูลการรับงาน', '2021-05-20 12:00:48', 'CNC / Laser', '0');
INSERT INTO `timeline` VALUES ('779', null, '806u6W7JFbCMXVkF4LIr0G', '6', '14', 'รับงาน', '2021-05-20 12:16:34', 'CNC / Laser(รับงาน)', '0');
INSERT INTO `timeline` VALUES ('780', null, '', '6', '14', 'รับงาน', '2021-05-20 12:16:44', 'CNC / Laser(รับงาน)', '0');
INSERT INTO `timeline` VALUES ('781', null, '806u6W7JFbCMXVkF4LIr0G', '6', '14', 'ส่งแก้ไขงาน', '2021-05-20 12:16:54', 'cnc / laser(ส่งแก้ไข กราฟิก / ออกแบบ)', '0');
INSERT INTO `timeline` VALUES ('782', null, 'qq6UhrH2J_97aT8-qTgJSl', '6', '14', 'รับงาน', '2021-05-20 13:36:27', 'CNC / Laser(รับงาน)', '0');
INSERT INTO `timeline` VALUES ('783', null, 'qq6UhrH2J_97aT8-qTgJSl', '6', '14', 'ส่งแก้ไขงาน', '2021-05-20 13:36:32', 'cnc / laser(ส่งแก้ไข กราฟิก / ออกแบบ)', '0');
INSERT INTO `timeline` VALUES ('784', null, 'fsTTQ7vstSByNncnJZoCxK', '3', '12', 'สั่งผลิต', '2021-05-20 13:39:01', 'งานพิมพ์,CNC / Laser', '0');
INSERT INTO `timeline` VALUES ('785', null, 'MZj6PndvG7ZpAROePYv3hw', '3', '17', 'สั่งผลิต', '2021-05-20 13:47:26', 'CNC / Laser', '0');
INSERT INTO `timeline` VALUES ('786', null, 'yO2fo8ixzYbacmJat6prjK', '1', '8', 'บันทึกข้อมูลการรับงาน', '2021-05-20 13:48:20', 'CNC / Laser', '0');
INSERT INTO `timeline` VALUES ('787', null, '8fqyNkmvDz-KnrxIAhlqpq', '1', '8', 'บันทึกข้อมูลการรับงาน', '2021-05-20 14:05:31', 'กราฟิก,งานพิมพ์,CNC / Laser,ผลิตทั่วไป', '0');
INSERT INTO `timeline` VALUES ('788', null, 'RjrS4s7oMr_ee2WLAKBJzO', '1', '8', 'บันทึกข้อมูลการรับงาน', '2021-05-20 14:36:09', 'กราฟิก,CNC / Laser,ผลิตทั่วไป', '0');
INSERT INTO `timeline` VALUES ('789', null, '8fqyNkmvDz-KnrxIAhlqpq', '3', '17', 'สั่งผลิต', '2021-05-20 14:52:26', 'งานพิมพ์,CNC / Laser', '0');
INSERT INTO `timeline` VALUES ('790', null, '6CLqIFoYZ84CDamOFl4bEw', '1', '8', 'บันทึกข้อมูลการรับงาน', '2021-05-20 15:01:04', 'CNC / Laser', '0');
INSERT INTO `timeline` VALUES ('791', null, '0Tn4Q_0bCtEWP5aEzzgogW', '1', '8', 'บันทึกข้อมูลการรับงาน', '2021-05-20 15:01:39', 'กราฟิก', '0');
INSERT INTO `timeline` VALUES ('792', null, 'o-ySwjoOAuPPCkM5vP0HwB', '12', '1', 'ส่งมอบงานลูกค้า', '2021-05-20 15:03:16', 'ส่งมอบงานลูกค้า', '0');
INSERT INTO `timeline` VALUES ('793', null, '5ldsZsOZWHoCYCyWUmNZbZ', '12', '1', 'ส่งมอบงานลูกค้า', '2021-05-20 15:03:19', 'ส่งมอบงานลูกค้า', '0');
INSERT INTO `timeline` VALUES ('794', null, 'yO2fo8ixzYbacmJat6prjK', '12', '1', 'ส่งมอบงานลูกค้า', '2021-05-20 15:03:27', 'ส่งมอบงานลูกค้า', '0');
INSERT INTO `timeline` VALUES ('795', null, 'N84zvp2EMGIVn0hjgkMIey', '12', '1', 'ส่งมอบงานลูกค้า', '2021-05-20 15:03:33', 'ส่งมอบงานลูกค้า', '0');
INSERT INTO `timeline` VALUES ('796', null, 'pdci6GgdMe4wBztYRnGZsv', '4', '1', 'งาน Approve', '2021-05-20 15:16:30', 'งาน Approve', '0');
INSERT INTO `timeline` VALUES ('797', null, 'fsTTQ7vstSByNncnJZoCxK', '4', '1', 'รับงาน', '2021-05-20 15:17:07', 'กราฟิก / ออกแบบ', '0');
INSERT INTO `timeline` VALUES ('798', null, 'yO2fo8ixzYbacmJat6prjK', '4', '1', 'งาน Approve', '2021-05-20 15:17:26', 'งาน Approve', '0');
INSERT INTO `timeline` VALUES ('799', null, '3qfWzNL0gNGXQjOCaR6YTi', '4', '1', 'งาน Approve', '2021-05-20 15:17:46', 'งาน Approve', '0');
INSERT INTO `timeline` VALUES ('800', null, '6CLqIFoYZ84CDamOFl4bEw', '4', '1', 'งาน Approve', '2021-05-20 15:18:16', 'งาน Approve', '0');
INSERT INTO `timeline` VALUES ('801', null, 'd54MvCz6fsOTye6WQpOq8v', '4', '1', 'งาน Approve', '2021-05-20 15:18:48', 'งาน Approve', '0');
INSERT INTO `timeline` VALUES ('802', null, 'o-ySwjoOAuPPCkM5vP0HwB', '4', '1', 'งาน Approve', '2021-05-20 15:19:06', 'งาน Approve', '0');
INSERT INTO `timeline` VALUES ('803', null, 'N84zvp2EMGIVn0hjgkMIey', '4', '1', 'รับงาน', '2021-05-20 15:19:27', 'กราฟิก / ออกแบบ', '0');
INSERT INTO `timeline` VALUES ('804', null, 'N84zvp2EMGIVn0hjgkMIey', '4', '1', 'งาน Approve', '2021-05-20 15:19:42', 'งาน Approve', '0');
INSERT INTO `timeline` VALUES ('805', null, '5ldsZsOZWHoCYCyWUmNZbZ', '4', '1', 'งาน Approve', '2021-05-20 15:19:51', 'งาน Approve', '0');
INSERT INTO `timeline` VALUES ('806', null, 'fsTTQ7vstSByNncnJZoCxK', '5', '13', 'ยืนยันการผลิต', '2021-05-20 15:32:31', 'งานพิมพ์(งานผลิตเสร็จแล้ว)', '0');
INSERT INTO `timeline` VALUES ('807', null, '8fqyNkmvDz-KnrxIAhlqpq', '5', '1', 'รับงาน', '2021-05-20 15:40:03', 'งานพิมพ์(รับงาน)', '0');
INSERT INTO `timeline` VALUES ('808', null, 'YYJ3v_hmOBiElGpMyOGLNB', '1', '1', 'บันทึกข้อมูลการรับงาน', '2021-05-20 19:22:14', 'กราฟิก', '0');
INSERT INTO `timeline` VALUES ('809', null, '806u6W7JFbCMXVkF4LIr0G', '5', '13', 'รับงาน', '2021-05-21 08:23:33', 'งานพิมพ์(รับงาน)', '0');
INSERT INTO `timeline` VALUES ('810', null, '806u6W7JFbCMXVkF4LIr0G', '5', '13', 'ยืนยันการผลิต', '2021-05-21 08:23:55', 'งานพิมพ์(งานผลิตเสร็จแล้ว)', '0');
INSERT INTO `timeline` VALUES ('811', null, '8fqyNkmvDz-KnrxIAhlqpq', '5', '13', 'ยืนยันการผลิต', '2021-05-21 08:23:58', 'งานพิมพ์(งานผลิตเสร็จแล้ว)', '0');
INSERT INTO `timeline` VALUES ('812', null, 'MqajoS1HfT_sxkz6i3JL_G', '1', '8', 'บันทึกข้อมูลการรับงาน', '2021-05-21 08:32:47', 'กราฟิก,งานพิมพ์,ผลิตทั่วไป', '0');
INSERT INTO `timeline` VALUES ('813', null, 'fsTTQ7vstSByNncnJZoCxK', '6', '15', 'ยืนยันการผลิต', '2021-05-21 08:50:42', 'ผลิตทั่วไป(งานผลิตเสร็จแล้ว)', '0');
INSERT INTO `timeline` VALUES ('814', null, 'RjrS4s7oMr_ee2WLAKBJzO', '7', '15', 'รับงาน', '2021-05-21 08:53:45', 'ผลิตทั่วไป(รับงาน)', '0');
INSERT INTO `timeline` VALUES ('815', null, 'YYJ3v_hmOBiElGpMyOGLNB', '1', '1', 'ยกเลิกงาน', '2021-05-21 08:58:15', 'ยกเลิกงาน', '2');
INSERT INTO `timeline` VALUES ('816', null, '806u6W7JFbCMXVkF4LIr0G', '1', '1', 'ยกเลิกงาน', '2021-05-21 08:58:42', 'ยกเลิกงาน', '2');
INSERT INTO `timeline` VALUES ('817', null, 'MqajoS1HfT_sxkz6i3JL_G', '3', '1', 'การตลาด / บัญชี(ตามงาน)', '2021-05-21 08:58:57', 'กราฟิก / ออกปบบ', '0');
INSERT INTO `timeline` VALUES ('818', null, 'ywleq_CPImHyHkSdrQIjPm', '1', '8', 'บันทึกข้อมูลการรับงาน', '2021-05-21 09:02:17', 'กราฟิก,งานพิมพ์,CNC / Laser', '0');
INSERT INTO `timeline` VALUES ('819', null, '', '7', '15', 'รับงาน', '2021-05-21 09:04:18', 'ผลิตทั่วไป(รับงาน)', '0');
INSERT INTO `timeline` VALUES ('820', null, 'RjrS4s7oMr_ee2WLAKBJzO', '6', '15', 'ยืนยันการผลิต', '2021-05-21 09:04:39', 'ผลิตทั่วไป(งานผลิตเสร็จแล้ว)', '0');
INSERT INTO `timeline` VALUES ('821', null, '8fqyNkmvDz-KnrxIAhlqpq', '7', '15', 'รับงาน', '2021-05-21 09:05:31', 'ผลิตทั่วไป(รับงาน)', '0');
INSERT INTO `timeline` VALUES ('822', null, '8fqyNkmvDz-KnrxIAhlqpq', '6', '15', 'ยืนยันการผลิต', '2021-05-21 09:05:39', 'ผลิตทั่วไป(งานผลิตเสร็จแล้ว)', '0');
INSERT INTO `timeline` VALUES ('823', null, '4K8kx-HFGqvMAId3uOB-jz', '1', '8', 'บันทึกข้อมูลการรับงาน', '2021-05-21 09:17:11', 'กราฟิก,CNC / Laser,ผลิตทั่วไป', '0');
INSERT INTO `timeline` VALUES ('824', null, 'RjrS4s7oMr_ee2WLAKBJzO', '3', '12', 'สั่งผลิต', '2021-05-21 09:42:44', 'CNC / Laser,ผลิตทั่วไป', '0');
INSERT INTO `timeline` VALUES ('825', null, '4K8kx-HFGqvMAId3uOB-jz', '3', '12', 'สั่งผลิต', '2021-05-21 09:43:22', 'CNC / Laser,ผลิตทั่วไป', '0');
INSERT INTO `timeline` VALUES ('826', null, '8fqyNkmvDz-KnrxIAhlqpq', '6', '17', 'รับงาน', '2021-05-21 10:29:40', 'CNC / Laser(รับงาน)', '0');
INSERT INTO `timeline` VALUES ('827', null, '8fqyNkmvDz-KnrxIAhlqpq', '6', '17', 'ส่งแก้ไขงาน', '2021-05-21 10:29:44', 'cnc / laser(ส่งแก้ไข กราฟิก / ออกแบบ)', '0');
INSERT INTO `timeline` VALUES ('828', null, '4K8kx-HFGqvMAId3uOB-jz', '7', '15', 'รับงาน', '2021-05-21 13:20:11', 'ผลิตทั่วไป(รับงาน)', '0');
INSERT INTO `timeline` VALUES ('829', null, '4K8kx-HFGqvMAId3uOB-jz', '6', '15', 'ยืนยันการผลิต', '2021-05-21 13:20:13', 'ผลิตทั่วไป(งานผลิตเสร็จแล้ว)', '0');
...
CREATE TABLE `transport` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=64 DEFAULT CHARSET=utf8 COMMENT='แผนกจัดส่ง';
...
INSERT INTO `transport` VALUES ('45', 'fsTTQ7vstSByNncnJZoCxK', null, '1', '0', null, null, null, null, null);
INSERT INTO `transport` VALUES ('49', 'YYJ3v_hmOBiElGpMyOGLNB', null, '1', '0', null, null, null, null, null);
INSERT INTO `transport` VALUES ('61', 'MqajoS1HfT_sxkz6i3JL_G', null, '1', '0', null, null, null, null, null);
INSERT INTO `transport` VALUES ('62', 'RjrS4s7oMr_ee2WLAKBJzO', null, '1', '0', null, null, null, null, null);
INSERT INTO `transport` VALUES ('63', '4K8kx-HFGqvMAId3uOB-jz', null, '1', '0', null, null, null, null, null);
...
INSERT INTO `uploads` VALUES ('60', 'fsTTQ7vstSByNncnJZoCxK', 'Aree.jpg', '944fe0b43944b16ad794365c1af51952.jpg', '2021-05-20 11:17:37', null, null, '1');
INSERT INTO `uploads` VALUES ('61', 'RinSJgLJcssu-JCWY9yBMK', '74414.jpg', '0b17e92a2e741b7e7c78738854b60430.jpg', '2021-05-20 11:56:07', null, null, '1');
INSERT INTO `uploads` VALUES ('62', 'MvDLdRwelWQmyu3Qc5EjSj', '1234546.jpg', '7ce39330a5b791e1f8b4b13d12a68a07.jpg', '2021-05-20 11:58:37', null, null, '1');
INSERT INTO `uploads` VALUES ('63', '806u6W7JFbCMXVkF4LIr0G', 'surfskate cnc uv.jpg', 'e67c28cf2f79af62357d36025ecf51e7.jpg', '2021-05-20 11:59:05', null, null, '1');
INSERT INTO `uploads` VALUES ('64', 'qq6UhrH2J_97aT8-qTgJSl', 'ตัดไม้เลข 9 cnc.jpg', '5f2881fce09ed40abda73c9227df334e.jpg', '2021-05-20 12:00:48', null, null, '1');
INSERT INTO `uploads` VALUES ('65', 'aJcaTmZe7jSo2pVBHwKqVW', '11111222.jpg', '24a632fe95b785ef4639e12f2aae0f49.jpg', '2021-05-20 13:38:51', null, null, '1');
INSERT INTO `uploads` VALUES ('66', 'YYJ3v_hmOBiElGpMyOGLNB', '3862_list.jpeg', '21ea5a243c524608ffb3be033e00b421.jpeg', '2021-05-20 19:22:14', null, null, '1');
INSERT INTO `uploads` VALUES ('67', 'YYJ3v_hmOBiElGpMyOGLNB', '11270506_989072404466200_6086238662844831063_o.jpeg', 'd1accf3bd9ebdd9d0d3704c9c779466a.jpeg', '2021-05-20 19:36:54', null, null, '1');
INSERT INTO `uploads` VALUES ('68', 'hzNd6GVhLfXg5CcvIvz1lW', '1621499943213.jpg', '04dd98de1c29cb49c52b688e58712407.jpg', '2021-05-21 09:42:30', null, null, '1');
INSERT INTO `uploads` VALUES ('69', 'WjMYt_T2Zp4zOXkiL4BPzO', 'messageImage_1621564861796.jpg', '2e55134e7d61741b3ded8bc0e7a2b7cc.jpg', '2021-05-21 09:43:20', null, null, '1');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', 'admin', 'kimniyomclub@gmail.com', '$2y$12$MenOVpHsMKOW0zYIFAD1ruqkamrLlEG1YIkcKOD9/eGmR9ECXzzsO', 'eVObZ98v26jv2RAmbdeUIlaHK4uJ8S-8', '1617557741', null, null, '::1', '1617557092', '1617557092', '0', '1621591657', 'A');
...
INSERT INTO `user` VALUES ('8', 'marketing1', 'marketing@natdesigntak.com', '$2y$12$s9nzt0ro08WKmok.HTgWIegzowEBAbE6gSwBGtp173ts28ndZ9ZJ6', 'bQYe0AA-eiJ69oCPWXDonoYYT1vbmXzY', '1620129337', null, null, '49.48.207.49', '1620129337', '1620129374', '0', '1621565923', 'U');
...
INSERT INTO `user` VALUES ('12', 'Graphic', 'graphic@natdesigntak.com', '$2y$12$N7T0Tt2c7XWS7hyxMdu5UOKKcJQe9S1lVjOpo6GafgRBD0JuDh/Oq', '3qtUEslIie7ne69JE8EVRq-vrRaQX3dl', '1620175500', null, null, '49.48.207.49', '1620175500', '1620175500', '0', '1621564893', 'U');
INSERT INTO `user` VALUES ('13', 'Printing', 'printing@natdesigntak.com', '$2y$12$dFsnaM4YK4hWmigMg7lkLON.F0GDfo8I3NDoU96PnqgsyxCbaNcOS', '4AXQJ3nEQeHgr2NJRbFDPg4bm41pGxNt', '1620175748', null, null, '49.48.207.49', '1620175748', '1620175748', '0', '1621571592', 'U');
INSERT INTO `user` VALUES ('14', 'Cutting', 'cutting@natdesigntak.com', '$2y$12$IIqEX/DEnGZQRsRoYc3cn.mhlCilwYtXxdeeMAfSwAoQpmfbJA6u.', 'UmkEjlfj1zIoE6EJV5fjgY3oFOlXsPjN', '1620175853', null, null, '49.48.207.49', '1620175853', '1620175853', '0', '1621567723', 'U');
INSERT INTO `user` VALUES ('15', 'Production', 'production@natdesigntak.com', '$2y$12$2do7mdU6ZiAhba/YEILfA.IczvN1rrN7h.SyNP0lh4sXqqBBQTgrK', 'wxUxRY0j2gB7G25KIiy_EDgwwjI7Ix1L', '1620175993', null, null, '49.48.207.49', '1620175993', '1620175993', '0', '1621561372', 'U');
...
INSERT INTO `user` VALUES ('17', 'nat', 'natmawan@gmail.com', '$2y$12$p4WPDbPmH.zqJS3jYlne3ei/W9mDR6q4Tdgt/VCh4bG5zyIW9MYmG', '-8BOjhYHFCiHXlkp8OJ3BHzW3fQd5mc4', '1620176380', null, null, '49.48.207.49', '1620176380', '1620892179', '0', '1621567769', 'A');
