...
CREATE TABLE `account` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=91 DEFAULT CHARSET=utf8 COMMENT='ตารางแผนกบัญชี';
...
INSERT INTO `account` VALUES (83, NULL, 'UauniDVW1pUZeShneZdjjz', NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL);
INSERT INTO `account` VALUES (84, NULL, 'PC16PlJVg_7Xd5YmGGg0mi', NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL);
INSERT INTO `account` VALUES (85, NULL, 'MZj6PndvG7ZpAROePYv3hw', NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL);
INSERT INTO `account` VALUES (86, NULL, 'CPzscmmVggSVGf8cyBCB0N', NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL);
INSERT INTO `account` VALUES (87, NULL, 'NwLzGmWHZCNiBoHvWJ_JVY', NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL);
INSERT INTO `account` VALUES (88, NULL, 'rvm9thaM0Tz5d_Npq8IjB5', NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL);
INSERT INTO `account` VALUES (89, NULL, 'YUWuIUIZ-FXoTHzsyEsSsg', NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL);
INSERT INTO `account` VALUES (90, NULL, 'CmvKcG5eHTn7HD4IIoeoMh', NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL);
COMMIT;
...
CREATE TABLE `branchfacture` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8 COMMENT='งานผลิตทั่วไป';
...
INSERT INTO `branchfacture` VALUES (38, 'pdci6GgdMe4wBztYRnGZsv', NULL, 1, 0, NULL, NULL, NULL);
COMMIT;
...
CREATE TABLE `branchlaser` (
  ...
  `comment` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8 COMMENT='งาน laser';
...
CREATE TABLE `branchprint` (
  ...
  `comment` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=56 DEFAULT CHARSET=utf8 COMMENT='งานพิมพ์';
...
INSERT INTO `branchprint` VALUES (55, 'YUWuIUIZ-FXoTHzsyEsSsg', NULL, 1, 0, NULL, NULL, NULL);
COMMIT;
...
CREATE TABLE `customer` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=97 DEFAULT CHARSET=utf8 COMMENT='เก็บรายละเอียดลูกค้า / รับงาน';
...
INSERT INTO `customer` VALUES (10, 'สติ๊กเกอร์ใส', 'OEL', '0617967260', 1, NULL, 'OEL', 'รับงานหน้าร้าน ', NULL, '<p>พิมพ์สติ๊กเกอร์ใส ขนาด 60x40cm = 2 ชิ้นๆละ 300.- = 600.-<br>(แบบที่ลูกค้าส่งมา) </p>', NULL, '2021-05-06', '13:00:00', '4', NULL, '2021-05-05 11:18:15', 8, '1-deFHIsDp8UH_1LfynQ33', 0, 0, 1, 1, 1, 1, 0, NULL, NULL, 2, 0, 2, 0, 1, 8, '2021-05-12 17:13:48', '', 1, 1);
...
INSERT INTO `customer` VALUES (27, 'สติ๊กเกอร์ติดรถ', 'fat boy ', '-', 4, NULL, 'ลูกค้าพี่ณัฐ ', 'ลูกค้าพี่ณัฐ ', NULL, '<p>สติ๊กเกอร์ติดรถ (สีแดง) </p><p>*** เพิ่มเติมสอบถามพี่ณัฐค่ะ ***</p>', NULL, '2021-05-10', '10:00:00', '3, 4', NULL, '2021-05-07 16:55:11', 8, 'lqPKHuXygVGDIpYsyI9kt7', 0, 1, 1, 1, 0, 1, 0, NULL, NULL, 2, 0, 0, 2, 1, 8, '2021-05-12 17:15:26', '', 1, 1);
...
INSERT INTO `customer` VALUES (31, 'สติ๊กเกอร์ฝ้า', 'kanjanun', '0882933687', 1, NULL, 'kanjanun', '* รับงานหน้าร้าน ', NULL, '<p>เพิ่มงานสติ๊กเกอร์ฝ้า 1 ชิ้น *แก้ไขที่อยู่ </p>', NULL, '2021-05-10', '10:00:00', '3, 4', NULL, '2021-05-08 10:10:11', 8, 'X77vrRC85W3ppSbUrwoP43', 0, 0, 0, 1, 1, 1, 0, NULL, NULL, 2, 0, 0, 0, 1, 8, '2021-05-12 17:15:41', '', 1, 1);
...
INSERT INTO `customer` VALUES (39, 'ฉากกั้นอะคริลิค', 'แซนมินา', '0000000000', 4, NULL, 'แซนนามิ ', '*ลูกค้าพี่ณัฐ ', NULL, '<p>ฉากกั้นอะคริลิค 3 mm. <br>* ข้อมูลเพิ่มเติมสอบถามพี่ณํฐ </p><p><br></p>', NULL, '2021-05-11', '14:00:00', '3, 4', NULL, '2021-05-10 15:14:14', 8, '0a4gSaSnJl_Hz8SJsWjb2G', 1, 0, 1, 1, 0, 1, 0, NULL, NULL, 2, 1, 0, 0, 1, 8, '2021-05-12 17:16:34', '', 1, 1);
INSERT INTO `customer` VALUES (40, 'สติ๊กเกอร์ไดคัท ', 'เก-ตุ-วะ-ดี', '0813791627', 1, NULL, 'เก-ตุ-วะ-ดี', '* รับงานหน้าร้าน ', NULL, '<p>สติ๊กเกอร์ไดคัท 1 แผ่น 80.- </p>', NULL, '2021-05-10', '17:00:00', '3, 4', NULL, '2021-05-10 15:52:20', 8, '7qdguXaqdFQZJR_asF_UfQ', 0, 0, 1, 1, 0, 1, 0, NULL, NULL, 2, 0, 0, 0, 1, 8, '2021-05-12 17:16:45', '', 1, 1);
...
INSERT INTO `customer` VALUES (44, 'ผ้าคลุมโต๊ะ', 'ณัฐดีไซน์', '0654944505', 3, NULL, '-', 'ส่งออฟฟิต', NULL, '<p>ไวนิลคลุมโต๊ะรับงาน</p>', NULL, '2021-05-12', '10:26:00', '3', NULL, '2021-05-11 10:28:15', 16, '6sPLpN7SmjvQLLKoafR940', 0, 1, 0, 1, 0, 1, 0, NULL, NULL, 2, 1, 2, 2, 1, 8, '2021-05-12 17:17:35', '', 1, 3);
...
INSERT INTO `customer` VALUES (47, 'ป้ายเครื่องดื่ม 2', 'ณัฐดีไซน์', '0654944505', 3, NULL, '-', '', NULL, '', NULL, '2021-05-11', '11:26:00', '3', NULL, '2021-05-11 11:28:12', 16, 'Qe-0jK3dcpTUbSEu8NCm_D', 0, 1, 0, 1, 0, 1, 0, NULL, NULL, 2, 1, 1, 2, 1, 16, '2021-05-12 17:17:56', '', 3, 3);
...
INSERT INTO `customer` VALUES (50, 'ส่งซัพผลิต', 'ณัฐดีไซน์', '0654944505', 3, NULL, '-', '', NULL, '', NULL, '2021-05-12', '15:57:00', '3', NULL, '2021-05-11 15:59:15', 1, 'jGzP_OORkZdjjEm2vxpLmd', 1, 1, 0, 1, 0, 1, 1, NULL, NULL, 0, 0, 0, 2, 1, 1, '2021-05-12 18:10:20', '', 4, 2);
...
INSERT INTO `customer` VALUES (52, 'ติดตั้งงาน ', 'ศึกษาธิการ ', '0886969154', 1, NULL, 'กาน ศึกษาธิการ ', 'ศึกษาธิการ  0886969154 คุณกาน', NULL, '<p>ติดตั้งงาน </p>', NULL, '2021-05-12', '09:00:00', '3, 4', NULL, '2021-05-12 08:56:55', 8, 'fU8hZ0tJOvyyp9j-LVPCge', 0, 1, 1, 1, 1, 1, 0, NULL, NULL, 0, 0, 2, 0, 1, NULL, '2021-05-12 17:18:24', '', 5, 1);
INSERT INTO `customer` VALUES (53, 'ติดตั้งงาน ', 'เทคโน ', '0000000000', 4, NULL, 'ลูกค้าพี่ณัฐ ', '-', NULL, '<p>เพิ่มเติมสอบถามพี่ณัฐ </p>', NULL, '2021-05-12', '10:00:00', '3, 4', NULL, '2021-05-12 08:58:26', 8, '7hyySzNtI_VR84GW8lXTdk', 0, 1, 1, 1, 1, 1, 0, NULL, NULL, 0, 0, 2, 2, 1, NULL, '2021-05-12 17:18:35', '', 5, 1);
...
INSERT INTO `customer` VALUES (55, 'ติดตั้งงาน ', 'พักกาย ', '0000000000', 4, NULL, 'ลูกค้าพี่ณัฐ ', 'พักกาย ', NULL, '<p>เพิ่มเติมสอบถามพี่ณัฐ </p>', NULL, '2021-05-12', '13:00:00', '3, 4', NULL, '2021-05-12 09:02:10', 8, 'CAcAJCWeZd-mKozrUigR0Q', 0, 1, 1, 1, 0, 1, 0, NULL, NULL, 0, 0, 2, 1, 1, NULL, '2021-05-12 17:19:33', '', 5, 1);
...
INSERT INTO `customer` VALUES (59, 'ทดสอบรับงานพร้อมโปรแกรมเมอร์', 'ทดสอบรับงานพร้อมโปรแกรมเมอร์', '', 2, NULL, '-', '', NULL, '<p>ทดสอบรับงานพร้อมโปรแกรมเมอร์</p>', NULL, '2021-05-12', '13:30:00', '3, 4', NULL, '2021-05-12 13:32:12', 1, 'hOUdPv_zaMEEKvcHnpsMx0', 1, 1, 0, 1, 1, 1, 0, NULL, NULL, 2, 2, 2, 0, 1, NULL, '2021-05-12 17:20:14', '', 3, 1);
...
INSERT INTO `customer` VALUES (62, 'ทดสอบสั่งงานผ่านแทบเลท gc', 'Nat', '0862149586', 2, NULL, '-', '', NULL, '<p>สั่งงานในแทบลทchrome</p>', NULL, '2021-05-12', '18:33:00', '3, 4', NULL, '2021-05-12 18:34:44', 1, 'dpLUbWwhqiNKCkrSJPsYl-', 1, 1, 0, 2, 1, 1, 0, 3, '', 0, 0, 0, 0, 0, NULL, NULL, NULL, 3, 1);
INSERT INTO `customer` VALUES (63, 'ทดสอบ auto refresh', 'srfgasdfg', 'sdf', 2, NULL, '-', '', NULL, '<p>ทดสอบ auto refresh</p>', NULL, '2021-05-12', '18:37:00', '3, 4', NULL, '2021-05-12 18:38:10', 1, '8_Zx2LZQiqPFUQ9TD0pywB', 1, 1, 0, 1, 1, 1, 0, NULL, NULL, 2, 2, 2, 0, 1, 1, '2021-05-12 19:39:24', '', 3, 1);
INSERT INTO `customer` VALUES (64, 'ทดสอบ auto refresh app w full screen brower', 'za', '', 2, NULL, '-', 'ฟห', NULL, '<p>ทดสอบ auto refresh app w full screen brower</p>', NULL, '2021-05-12', '18:50:00', '3', NULL, '2021-05-12 18:50:46', 1, 'ETPpDvNmIFEB4j4Tgi32oj', 1, 0, 0, 1, 1, 1, 0, NULL, NULL, 2, 2, 0, 0, 1, 1, '2021-05-13 13:13:05', '', 1, 2);
INSERT INTO `customer` VALUES (65, 'ทดสอบแอพใหม่', 'sdf', '', 2, NULL, '-', 'หกกด', NULL, '<p>ทดสอบแอพใหม่</p>', NULL, '2021-05-12', '19:34:00', '3', NULL, '2021-05-12 19:35:02', 1, 'cRO9HGZyoNvFVnlA-59Xt2', 1, 0, 0, 1, 1, 1, 0, NULL, NULL, 1, 1, 1, 0, 1, 1, '2021-05-13 13:13:14', '', 1, 1);
...
INSERT INTO `customer` VALUES (68, 'ไวนิลและอื่นๆ ', 'จ๊ะจ๋า', '0000000000', 3, NULL, '-', 'ลูกค้าพี่ณัฐ ', NULL, '<p>ลูกค้าพี่ณัฐ </p>', NULL, '2021-05-13', '17:00:00', '3, 4', NULL, '2021-05-13 13:09:25', 8, 'R0s6646_Wy1RQU0tH3feJI', 0, 0, 1, 1, 1, 1, 0, NULL, NULL, 1, 0, 0, 0, 1, NULL, '2021-05-14 15:17:04', '', 5, 1);
INSERT INTO `customer` VALUES (69, 'พลาสวูดพิมพ์ยูวี ', 'ยูเท็กซ์ไทล์ (ลูกค้าพี่ณัฐ)', '0000000000', 3, NULL, '-', 'ลูกค้าพี่ณัฐ ', NULL, '<p>ลูกค้าพี่ณัฐ </p>', NULL, '2021-05-13', '13:10:00', '3, 4', NULL, '2021-05-13 13:11:49', 8, '29jO6OBZ-DcyKJAPbAkR-D', 1, 0, 1, 1, 1, 1, 0, NULL, NULL, 2, 0, 0, 0, 1, NULL, '2021-05-14 15:17:22', '', 4, 1);
...
INSERT INTO `customer` VALUES (76, 'อะคริลิคดำพิมพ์ยูวี ', 'บังคับคดี', '0000000000', 4, NULL, 'ลูกค้าพี่ณัฐ ', '-', NULL, '<p>งานลูกค้าพี่ณัฐ </p>', NULL, '2021-05-14', '11:48:00', '3, 4', NULL, '2021-05-14 11:51:27', 8, 'ZJefNzuDnS-HvShoWa7gUZ', 0, 0, 1, 0, 0, 1, 0, NULL, NULL, 2, 1, 0, 0, 0, NULL, NULL, NULL, 5, 1);
INSERT INTO `customer` VALUES (77, 'อะคริลิคพิมพ์ยูวี', 'เคลมงานการไฟฟ้า ', '0861851903', 1, NULL, 'Don Aladin50', 'รับงานหน้าร้าน ', NULL, '<p>งานเคลม </p>', NULL, '2021-05-15', '16:30:00', '3, 4', NULL, '2021-05-14 13:46:26', 8, 'NMU8hYni2hQJzcGWzEnwYe', 0, 0, 1, 1, 0, 1, 0, NULL, NULL, 0, 0, 0, 0, 1, NULL, '2021-05-14 15:20:01', '', 2, 3);
INSERT INTO `customer` VALUES (78, 'ทดสอบเวลาแท็บเล็ทใหม่', 'ณัฐ', '0862149586', 2, NULL, '-', '', NULL, '<p>ทดสอบการแสดงผลในแท็บเล็ตใหม่</p>', NULL, '2021-05-14', '16:12:00', '3, 4', NULL, '2021-05-14 16:13:46', 1, '6fB4CAg1KJL5Ald2p5xlJC', 1, 1, 0, 1, 1, 1, 0, NULL, NULL, 2, 0, 0, 0, 1, NULL, '2021-05-15 14:10:29', '', 5, 3);
...
INSERT INTO `customer` VALUES (80, 'ทดสอบเวลา 2', 'ณัฐ2', '565465', 2, NULL, '-', '', NULL, '', NULL, '2021-05-14', '16:20:00', '3', NULL, '2021-05-14 16:21:12', 1, '1ePJlxC9Iy1cvLIJvG6kav', 1, 0, 0, 1, 1, 1, 0, NULL, NULL, 2, 0, 0, 0, 1, NULL, '2021-05-15 14:10:34', '', 1, 2);
...
INSERT INTO `customer` VALUES (87, 'นิทรรศการกาดต้าตง', 'พี่หนุ่ยวัฒนธรรม', '0818742571', 1, NULL, 'ลูกค้าพี่ณัฐ ', '', NULL, '<p>นิทรรศการกาดต้าตง </p><p>*ข้อมูลเพิ่มเติมสอบถามพี่ณัฐ</p>', NULL, '2021-05-17', '10:30:00', '3, 4', NULL, '2021-05-15 15:24:37', 8, 'c3eU7ywfowEQmyw0IjMhaQ', 0, 1, 1, 0, 1, 1, 0, NULL, NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, 4, 1);
...
CREATE TABLE `department` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='ตารางแผนก';
...
CREATE TABLE `graphic` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=97 DEFAULT CHARSET=utf8 COMMENT='ตารางแผนกกราฟิก';
...
INSERT INTO `graphic` VALUES (90, 'PC16PlJVg_7Xd5YmGGg0mi', NULL, NULL, '', '', NULL, NULL, 0, 0, NULL, NULL, 1, NULL);
INSERT INTO `graphic` VALUES (91, 'MZj6PndvG7ZpAROePYv3hw', NULL, NULL, '', '', NULL, NULL, 0, 0, NULL, NULL, 1, NULL);
INSERT INTO `graphic` VALUES (92, 'CPzscmmVggSVGf8cyBCB0N', NULL, NULL, '', '', NULL, NULL, 0, 0, NULL, NULL, 1, NULL);
...
INSERT INTO `graphic` VALUES (94, 'rvm9thaM0Tz5d_Npq8IjB5', NULL, NULL, '', '', NULL, NULL, 0, 0, NULL, NULL, 1, NULL);
...
CREATE TABLE `queue` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='ตารางคิวงานติดตั้ง ส่งมาเมื่อกราฟฟิกบันทึกข้อมูล';
...
INSERT INTO `queue` VALUES (21, 'bJQg87V6EFNI-IYOZZXBsJ', NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL);
INSERT INTO `queue` VALUES (22, 'YUWuIUIZ-FXoTHzsyEsSsg', NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL);
COMMIT;
...
CREATE TABLE `timeline` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=688 DEFAULT CHARSET=utf8 COMMENT='ตารางเก็บประวัติการทำงาน';
...
CREATE TABLE `transport` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8 COMMENT='แผนกจัดส่ง';
...
-- ----------------------------
BEGIN;
INSERT INTO `user` VALUES (1, 'admin', 'kimniyomclub@gmail.com', '$2y$12$MenOVpHsMKOW0zYIFAD1ruqkamrLlEG1YIkcKOD9/eGmR9ECXzzsO', 'eVObZ98v26jv2RAmbdeUIlaHK4uJ8S-8', 1617557741, NULL, NULL, '::1', 1617557092, 1617557092, 0, 1621233880, 'A');
...
INSERT INTO `user` VALUES (8, 'marketing1', 'marketing@natdesigntak.com', '$2y$12$s9nzt0ro08WKmok.HTgWIegzowEBAbE6gSwBGtp173ts28ndZ9ZJ6', 'bQYe0AA-eiJ69oCPWXDonoYYT1vbmXzY', 1620129337, NULL, NULL, '49.48.207.49', 1620129337, 1620129374, 0, 1621233295, 'U');
...
INSERT INTO `user` VALUES (12, 'Graphic', 'graphic@natdesigntak.com', '$2y$12$N7T0Tt2c7XWS7hyxMdu5UOKKcJQe9S1lVjOpo6GafgRBD0JuDh/Oq', '3qtUEslIie7ne69JE8EVRq-vrRaQX3dl', 1620175500, NULL, NULL, '49.48.207.49', 1620175500, 1620175500, 0, 1621234772, 'U');
INSERT INTO `user` VALUES (13, 'Printing', 'printing@natdesigntak.com', '$2y$12$dFsnaM4YK4hWmigMg7lkLON.F0GDfo8I3NDoU96PnqgsyxCbaNcOS', '4AXQJ3nEQeHgr2NJRbFDPg4bm41pGxNt', 1620175748, NULL, NULL, '49.48.207.49', 1620175748, 1620175748, 0, 1621246971, 'U');
...
INSERT INTO `user` VALUES (15, 'Production', 'production@natdesigntak.com', '$2y$12$2do7mdU6ZiAhba/YEILfA.IczvN1rrN7h.SyNP0lh4sXqqBBQTgrK', 'wxUxRY0j2gB7G25KIiy_EDgwwjI7Ix1L', 1620175993, NULL, NULL, '49.48.207.49', 1620175993, 1620175993, 0, 1621220543, 'U');
...
INSERT INTO `user` VALUES (17, 'nat', 'natmawan@gmail.com', '$2y$12$p4WPDbPmH.zqJS3jYlne3ei/W9mDR6q4Tdgt/VCh4bG5zyIW9MYmG', '-8BOjhYHFCiHXlkp8OJ3BHzW3fQd5mc4', 1620176380, NULL, NULL, '49.48.207.49', 1620176380, 1620892179, 0, 1621216283, 'A');
