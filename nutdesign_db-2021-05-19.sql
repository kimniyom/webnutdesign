...
INSERT INTO `account` VALUES (100, NULL, 'tS0XNs30MdcLuxutSWM4G0', NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL);
...
CREATE TABLE `timeline` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=765 DEFAULT CHARSET=utf8 COMMENT='ตารางเก็บประวัติการทำงาน';
...
INSERT INTO `user` VALUES (8, 'marketing1', 'marketing@natdesigntak.com', '$2y$12$s9nzt0ro08WKmok.HTgWIegzowEBAbE6gSwBGtp173ts28ndZ9ZJ6', 'bQYe0AA-eiJ69oCPWXDonoYYT1vbmXzY', 1620129337, NULL, NULL, '49.48.207.49', 1620129337, 1620129374, 0, 1621408252, 'U');
INSERT INTO `user` VALUES (9, 'Accounts1', 'ac1@natdesigntak.com', '$2y$12$X5TE/UD40FwEmZj3BRjc5uypvXluCVFGXRrW1pFcsLllrPY8NRtp6', 'eKLsvIznGZzAiyFlsn6Qvds00HEQfqbM', 1620129817, NULL, NULL, '49.48.207.49', 1620129817, 1620130114, 0, 1621388368, 'U');
