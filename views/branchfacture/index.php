...
<script>
    ...
    function getJob() {
        var url = "<?php echo Yii::$app->urlManager->createUrl(['branchfacture/getjob']) ?>";
    ...
    function searchJob() {
        ...
        var url = "<?php echo Yii::$app->urlManager->createUrl(['branchfacture/searchjob']) ?>";
    ...
    function updateConfirmStatus() {
        ...
        var url = "<?php echo Yii::$app->urlManager->createUrl(['branchfacture/confirmwork']) ?>";
