...
<div class="transport-index">
    ...
    <div class="row" style="margin-bottom: 0px;">
        <div class="col-lg-12 col-md-12">
            <div id="body-work" style="margin-top: 1px; overflow: auto;">
                <div id="job">
    ...
    <script>
        function setScreens() {
            ...
            if (w > 1024) {
                ...
                $(".head-mobile").html("<font style='color:#FFFFFF;'>รับหน้าร้าน</font>");
        ...
        function searchJob() {
            ...
            var url = "<?php echo Yii::$app->urlManager->createUrl(['customer/searchapprove']) ?>";
