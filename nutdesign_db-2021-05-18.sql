...
CREATE TABLE `account` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=92 DEFAULT CHARSET=utf8 COMMENT='ตารางแผนกบัญชี';
...
INSERT INTO `account` VALUES ('91', null, 'sE4Bo7KJAI-VymDWuR5SoJ', null, null, null, null, '0', '0', null, null, null, null);
...
CREATE TABLE `customer` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=98 DEFAULT CHARSET=utf8 COMMENT='เก็บรายละเอียดลูกค้า / รับงาน';
...
INSERT INTO `customer` VALUES ('97', 'โล่ห์รางวัล 2 ชิ้น', 'หัสต์กมล พช.จว.ตาก', '0953060945 พี่ีน้อง', '1', null, 'หัสต์กมล พช.จว.ตาก', 'สำนักงานพัฒนาชุมชนจังหวัดตาก (พี่น้อง)\r\nศาลากลางจังหวัดตาก ชั้น 2', null, '<p>โลห์รางวัล 2 ชิ้น </p><p>รายละเอียดข้อความ รบกวนดูที่ไลน์ลูกค้าค่ะ</p><p><br></p>', null, '2021-05-21', '09:00:00', '3, 4', null, '2021-05-18 08:45:17', '8', 'sE4Bo7KJAI-VymDWuR5SoJ', '0', '0', '1', '0', '0', '1', '0', null, null, '0', '0', '0', '0', '0', null, null, null, '4', '1');
...
CREATE TABLE `graphic` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=98 DEFAULT CHARSET=utf8 COMMENT='ตารางแผนกกราฟิก';
...
CREATE TABLE `timeline` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=693 DEFAULT CHARSET=utf8 COMMENT='ตารางเก็บประวัติการทำงาน';
...
CREATE TABLE `transport` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8 COMMENT='แผนกจัดส่ง';
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', 'admin', 'kimniyomclub@gmail.com', '$2y$12$MenOVpHsMKOW0zYIFAD1ruqkamrLlEG1YIkcKOD9/eGmR9ECXzzsO', 'eVObZ98v26jv2RAmbdeUIlaHK4uJ8S-8', '1617557741', null, null, '::1', '1617557092', '1617557092', '0', '1621301756', 'A');
...
INSERT INTO `user` VALUES ('8', 'marketing1', 'marketing@natdesigntak.com', '$2y$12$s9nzt0ro08WKmok.HTgWIegzowEBAbE6gSwBGtp173ts28ndZ9ZJ6', 'bQYe0AA-eiJ69oCPWXDonoYYT1vbmXzY', '1620129337', null, null, '49.48.207.49', '1620129337', '1620129374', '0', '1621302133', 'U');
...
INSERT INTO `user` VALUES ('13', 'Printing', 'printing@natdesigntak.com', '$2y$12$dFsnaM4YK4hWmigMg7lkLON.F0GDfo8I3NDoU96PnqgsyxCbaNcOS', '4AXQJ3nEQeHgr2NJRbFDPg4bm41pGxNt', '1620175748', null, null, '49.48.207.49', '1620175748', '1620175748', '0', '1621300671', 'U');
