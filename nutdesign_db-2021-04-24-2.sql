...
INSERT INTO `account` VALUES ('7', null, 'kLcYl1xutvs4w9IwAX7cov', null, null, null, null, '0', '0', null, null, null, null);
...
INSERT INTO `account` VALUES ('9', null, '-rwb3A8KYS0dTuDWZc4DRT', null, null, null, null, '0', '0', null, null, null, null);
...
CREATE TABLE `branchfacture` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='งานผลิตทั่วไป';
...
CREATE TABLE `branchlaser` (
  ...
  `flag` int(1) DEFAULT '0' COMMENT '0 = NoApprove 1 = Approve 2 =  Cancel',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='งาน laser';
...
-- ----------------------------
INSERT INTO `branchprint` VALUES ('1', 'CH-65aQi1QVCFyaTkdQk5F', null, '1', '0');
INSERT INTO `branchprint` VALUES ('2', 'QdZJar3nEGX29yFlmRp4tt', null, '1', '0');
...
INSERT INTO `graphic` VALUES ('2', '-rwb3A8KYS0dTuDWZc4DRT', null, null, '', '', null, null, '0', '0', null, null, '1', null);
...
CREATE TABLE `timeline` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='ตารางเก็บประวัติการทำงาน';

-- ----------------------------
-- Records of timeline
-- ----------------------------
INSERT INTO `timeline` VALUES ('1', null, 'kLcYl1xutvs4w9IwAX7cov', '1', '1', 'บันทึกข้อมูลการรับงาน', '2021-04-24 02:12:20', 'บัญชี', '0');
INSERT INTO `timeline` VALUES ('2', null, 'QdZJar3nEGX29yFlmRp4tt', '4', '1', 'รับงาน', '2021-04-24 16:35:43', 'กราฟิก / ออกแบบ', '0');
INSERT INTO `timeline` VALUES ('3', null, '-rwb3A8KYS0dTuDWZc4DRT', '1', '1', 'บันทึกข้อมูลการรับงาน', '2021-04-24 02:19:01', 'กราฟิก,บัญชี', '0');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', 'admin', 'kimniyomclub@gmail.com', '$2y$12$MenOVpHsMKOW0zYIFAD1ruqkamrLlEG1YIkcKOD9/eGmR9ECXzzsO', 'eVObZ98v26jv2RAmbdeUIlaHK4uJ8S-8', '1617557741', null, null, '::1', '1617557092', '1617557092', '0', '1619256159', 'A');
