...
CREATE TABLE `account` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=109 DEFAULT CHARSET=utf8 COMMENT='ตารางแผนกบัญชี';
...
CREATE TABLE `branchfacture` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8 COMMENT='งานผลิตทั่วไป';
...
INSERT INTO `branchfacture` VALUES ('41', 'fsTTQ7vstSByNncnJZoCxK', '15', '2', '0', '2021-05-20 11:53:28', null, null);
...
INSERT INTO `branchfacture` VALUES ('45', '8fqyNkmvDz-KnrxIAhlqpq', null, '1', '0', null, null, null);
INSERT INTO `branchfacture` VALUES ('46', 'RjrS4s7oMr_ee2WLAKBJzO', null, '1', '0', null, null, null);
...
CREATE TABLE `branchlaser` (
  ...
  `comment` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8 COMMENT='งาน laser';
...
INSERT INTO `branchlaser` VALUES ('34', '806u6W7JFbCMXVkF4LIr0G', '14', '4', '0', '2021-05-20 12:16:34', '2021-05-20 12:16:54', '');
...
INSERT INTO `branchlaser` VALUES ('38', '8fqyNkmvDz-KnrxIAhlqpq', null, '1', '0', null, null, null);
...
CREATE TABLE `branchprint` (
  ...
  `comment` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=65 DEFAULT CHARSET=utf8 COMMENT='งานพิมพ์';
...
INSERT INTO `branchprint` VALUES ('63', '806u6W7JFbCMXVkF4LIr0G', null, '1', '0', null, null, null);
INSERT INTO `branchprint` VALUES ('64', '8fqyNkmvDz-KnrxIAhlqpq', '1', '2', '0', '2021-05-20 15:40:03', null, null);
...
CREATE TABLE `customer` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=122 DEFAULT CHARSET=utf8 COMMENT='เก็บรายละเอียดลูกค้า / รับงาน';
...
INSERT INTO `customer` VALUES ('115', 'surfskate ', 'ลูกค้าพี่ณัฐ', '', '3', '', '', '-', null, '<p>-</p>', null, '2021-05-20', '11:56:00', '5, 6', null, '2021-05-20 11:59:05', '8', '806u6W7JFbCMXVkF4LIr0G', '0', '0', '0', '0', '0', '1', '0', null, null, '0', '2', '0', '0', '0', null, null, null, '5', '1', '4');
...
INSERT INTO `customer` VALUES ('118', 'surfskate', 'One1', '', '1', 'One1', '', '-', null, '<p>surfskate ข้อความว่า hangover<br><br>*พี่ณัฐดูแลงานออกแบบให้ <span class=\"redactor-invisible-space\"></span></p>', null, '2021-05-21', '10:00:00', '3, 5, 6, 7', null, '2021-05-20 14:05:31', '8', '8fqyNkmvDz-KnrxIAhlqpq', '0', '0', '0', '0', '0', '1', '0', null, null, '0', '0', '0', '0', '0', null, null, null, '5', '1', '4');
INSERT INTO `customer` VALUES ('119', 'บล็อคพ่นสี', 'yai', '0851003160', '1', 'yai', '', 'ร้านทำทุกอย่างดอทคอม  \r\nK เข้ม 0851003160\r\n\r\nเลขตึก  162/532  บางแคคอนโดทาวน  \r\nห้อง 168 อาคารพาณิชย์  ก่อนถึงศาลพระภูมิ  \r\nถ.เพชรเกษม   แขวงบางแคเหนือ เขตบางแค  กรุงเทพ 10160', null, '<p>บล็อคพ่นสี ขนาด 45x16 ซม. 1 ชิ้นๆละ 160.- รวมจัดส่ง<br>*ข้อมูลอยู่ในเมล์<br>*งานแก้ไข</p>', null, '2021-05-20', '11:30:00', '3, 6, 7', null, '2021-05-20 14:36:09', '8', 'RjrS4s7oMr_ee2WLAKBJzO', '1', '0', '0', '0', '0', '1', '0', null, null, '0', '0', '0', '0', '0', null, null, null, '5', '3', '4');
...
CREATE TABLE `graphic` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=119 DEFAULT CHARSET=utf8 COMMENT='ตารางแผนกกราฟิก';
...
INSERT INTO `graphic` VALUES ('117', 'RjrS4s7oMr_ee2WLAKBJzO', null, null, '', '', null, null, '0', '0', null, null, '1', null);
...
CREATE TABLE `rule` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=92 DEFAULT CHARSET=utf8 COMMENT='สิทธิ์การเข้าถึงแผนก';
...
CREATE TABLE `timeline` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=808 DEFAULT CHARSET=utf8 COMMENT='ตารางเก็บประวัติการทำงาน';
...
CREATE TABLE `transport` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=48 DEFAULT CHARSET=utf8 COMMENT='แผนกจัดส่ง';
...
INSERT INTO `transport` VALUES ('47', 'RjrS4s7oMr_ee2WLAKBJzO', null, '1', '0', null, null, null, null, null);
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', 'admin', 'kimniyomclub@gmail.com', '$2y$12$MenOVpHsMKOW0zYIFAD1ruqkamrLlEG1YIkcKOD9/eGmR9ECXzzsO', 'eVObZ98v26jv2RAmbdeUIlaHK4uJ8S-8', '1617557741', null, null, '::1', '1617557092', '1617557092', '0', '1621499550', 'A');
...
INSERT INTO `user` VALUES ('8', 'marketing1', 'marketing@natdesigntak.com', '$2y$12$s9nzt0ro08WKmok.HTgWIegzowEBAbE6gSwBGtp173ts28ndZ9ZJ6', 'bQYe0AA-eiJ69oCPWXDonoYYT1vbmXzY', '1620129337', null, null, '49.48.207.49', '1620129337', '1620129374', '0', '1621498877', 'U');
...
INSERT INTO `user` VALUES ('12', 'Graphic', 'graphic@natdesigntak.com', '$2y$12$N7T0Tt2c7XWS7hyxMdu5UOKKcJQe9S1lVjOpo6GafgRBD0JuDh/Oq', '3qtUEslIie7ne69JE8EVRq-vrRaQX3dl', '1620175500', null, null, '49.48.207.49', '1620175500', '1620175500', '0', '1621478844', 'U');
INSERT INTO `user` VALUES ('13', 'Printing', 'printing@natdesigntak.com', '$2y$12$dFsnaM4YK4hWmigMg7lkLON.F0GDfo8I3NDoU96PnqgsyxCbaNcOS', '4AXQJ3nEQeHgr2NJRbFDPg4bm41pGxNt', '1620175748', null, null, '49.48.207.49', '1620175748', '1620175748', '0', '1621499515', 'U');
INSERT INTO `user` VALUES ('14', 'Cutting', 'cutting@natdesigntak.com', '$2y$12$IIqEX/DEnGZQRsRoYc3cn.mhlCilwYtXxdeeMAfSwAoQpmfbJA6u.', 'UmkEjlfj1zIoE6EJV5fjgY3oFOlXsPjN', '1620175853', null, null, '49.48.207.49', '1620175853', '1620175853', '0', '1621492379', 'U');
INSERT INTO `user` VALUES ('15', 'Production', 'production@natdesigntak.com', '$2y$12$2do7mdU6ZiAhba/YEILfA.IczvN1rrN7h.SyNP0lh4sXqqBBQTgrK', 'wxUxRY0j2gB7G25KIiy_EDgwwjI7Ix1L', '1620175993', null, null, '49.48.207.49', '1620175993', '1620175993', '0', '1621486378', 'U');
...
INSERT INTO `user` VALUES ('17', 'nat', 'natmawan@gmail.com', '$2y$12$p4WPDbPmH.zqJS3jYlne3ei/W9mDR6q4Tdgt/VCh4bG5zyIW9MYmG', '-8BOjhYHFCiHXlkp8OJ3BHzW3fQd5mc4', '1620176380', null, null, '49.48.207.49', '1620176380', '1620892179', '0', '1621479990', 'A');
