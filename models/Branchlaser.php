...
/**
 * This is the model class for table "branchlaser".
 *
 * @property int $id
 ...
 */
class Branchlaser extends \yii\db\ActiveRecord {
    ...
    function searchJob($customer = "", $project = "") {
        ...
        $sql = "select c.*,g.status from branchlaser g INNER JOIN customer c ON g.ref = c.ref WHERE c.flag = '0' $where";
