...
/**
 * This is the model class for table "branchprint".
 *
 * @property int $id
 ...
 */
class Branchprint extends \yii\db\ActiveRecord {
    ...
    function searchJob($customer = "", $project = "") {
        ...
        $sql = "select c.*,g.status from branchprint g INNER JOIN customer c ON g.ref = c.ref WHERE c.flag != 2 $where";
