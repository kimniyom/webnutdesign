...
<html lang="<?= Yii::$app->language ?>">
    ...
    <body class="skin-default-dark fixed-layout" style=" background: #eac0d6;">
                    ...
                    <div class="navbar-collapse">
                        ...
                        <ul class="navbar-nav my-lg-0">
                            <?php if (!Yii::$app->user->isGuest) { ?>
                                ...
                                <?php } ?>
                                <li class="nav-item dropdown">
                                    <a class="nav-link" href="<?php echo Yii::$app->urlManager->createUrl(['site/logout']) ?>" style=" color: #FFFFFF;" onclick="logOut()">
        ...
        <script>
                                        ...
                                        function logOut() {
                                            localStorage.removeItem('natdesign_username');
                                            localStorage.removeItem('natdesign_password');
                                            /*
                                        ...
                                        function checkLogin() {
                                            ...
                                            var setUsername = "<?php echo \Yii::$app->session->get('natdesign_username') ?>";
                                            var setPassword = "<?php echo \Yii::$app->session->get('natdesign_password') ?>";
                                            localStorage.setItem("natdesign_username", setUsername);
                                            localStorage.setItem("natdesign_password", setPassword);
                                            if (user) {
                                                window.location = url;
                                            }
                                        }
