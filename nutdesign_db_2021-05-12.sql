...
CREATE TABLE `account` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=51 DEFAULT CHARSET=utf8 COMMENT='ตารางแผนกบัญชี';
...
INSERT INTO `account` VALUES ('47', null, 'd3EZeq2qOc1sfftpV5q19D', null, null, null, null, '0', '0', null, null, null, null);
INSERT INTO `account` VALUES ('48', null, 'fU8hZ0tJOvyyp9j-LVPCge', null, null, null, null, '0', '0', null, null, null, null);
INSERT INTO `account` VALUES ('49', null, '7hyySzNtI_VR84GW8lXTdk', null, null, null, null, '0', '0', null, null, null, null);
INSERT INTO `account` VALUES ('50', null, 'hrmv4WPvcupLaEF9BnJnT0', null, null, null, null, '0', '0', null, null, null, null);
...
CREATE TABLE `branchfacture` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8 COMMENT='งานผลิตทั่วไป';
...
INSERT INTO `branchfacture` VALUES ('10', 'BdSi1aloNqzKqs1dRzh_Mb', null, '1', '0', null, null, null);
INSERT INTO `branchfacture` VALUES ('11', 'ZJpRfgA-Sg1-iQ0c_lFTPA', '8', '4', '0', '2021-05-07 16:14:16', '2021-05-07 16:14:18', null);
INSERT INTO `branchfacture` VALUES ('12', '-D3HjJnBYj_bngAK3ut3Nc', null, '1', '0', null, null, null);
...
INSERT INTO `branchfacture` VALUES ('15', 'ASSAjitIb9LjfuW4kfBfqk', null, '1', '0', null, null, null);
...
INSERT INTO `branchfacture` VALUES ('18', 'Nm8YXtbe5__ByiIayzf8KA', null, '1', '0', null, null, null);
INSERT INTO `branchfacture` VALUES ('19', 'LTJBdwfKR1fPJgSt96JA-c', null, '1', '0', null, null, null);
INSERT INTO `branchfacture` VALUES ('20', '9lLpBEMv3URV9CIKowTvtp', null, '1', '0', null, null, null);
INSERT INTO `branchfacture` VALUES ('21', 'n3TfnfxsKFdQQFeDT5AEVI', null, '1', '0', null, null, null);
INSERT INTO `branchfacture` VALUES ('22', 'ZevKuy2Fnz8Bmpa1RsXKSI', null, '1', '0', null, null, null);
INSERT INTO `branchfacture` VALUES ('23', 'lER6-HE2lJwDeTY21TlJ6s', null, '1', '0', null, null, null);
...
CREATE TABLE `branchlaser` (
  ...
  `comment` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8 COMMENT='งาน laser';
...
CREATE TABLE `branchprint` (
  ...
  `comment` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8 COMMENT='งานพิมพ์';
...
INSERT INTO `branchprint` VALUES ('32', 'XMXoW-yaSzIWCiUTtjiXFW', null, '1', '0', null, null, null);
INSERT INTO `branchprint` VALUES ('33', 'lqPKHuXygVGDIpYsyI9kt7', '1', '4', '0', '2021-05-11 17:39:06', '2021-05-11 17:39:10', 'Jubjub');
INSERT INTO `branchprint` VALUES ('34', 'n3TfnfxsKFdQQFeDT5AEVI', null, '1', '0', null, null, null);
...
INSERT INTO `branchprint` VALUES ('39', 'EHtNT9tpNc1i28UkoTlfXb', null, '1', '0', null, null, null);
...
CREATE TABLE `graphic` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=54 DEFAULT CHARSET=utf8 COMMENT='ตารางแผนกกราฟิก';
...
INSERT INTO `graphic` VALUES ('27', 'lqPKHuXygVGDIpYsyI9kt7', null, '', '', 'AQdMr97VrRJq_kqzlT1Opw', '1', null, '1', '0', '2021-05-11 15:40:29', '2021-05-11 15:40:29', '2', '5');
...
INSERT INTO `graphic` VALUES ('50', 'jGzP_OORkZdjjEm2vxpLmd', null, '', '', 'T07Aja2Nl0KTTIuiYwLkux', '1', null, '1', '0', '2021-05-11 15:59:54', '2021-05-11 15:59:54', '4', null);
INSERT INTO `graphic` VALUES ('51', 'd3EZeq2qOc1sfftpV5q19D', null, null, '', '', null, null, '0', '0', null, null, '1', null);
INSERT INTO `graphic` VALUES ('52', 'fU8hZ0tJOvyyp9j-LVPCge', null, null, '', '', null, null, '0', '0', null, null, '1', null);
INSERT INTO `graphic` VALUES ('53', '7hyySzNtI_VR84GW8lXTdk', null, null, '', '', null, null, '0', '0', null, null, '1', null);
...
CREATE TABLE `queue` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='ตารางคิวงานติดตั้ง ส่งมาเมื่อกราฟฟิกบันทึกข้อมูล';
...
CREATE TABLE `rule` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=85 DEFAULT CHARSET=utf8 COMMENT='สิทธิ์การเข้าถึงแผนก';
...
CREATE TABLE `timeline` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=346 DEFAULT CHARSET=utf8 COMMENT='ตารางเก็บประวัติการทำงาน';
...
INSERT INTO `timeline` VALUES ('290', null, 'd3EZeq2qOc1sfftpV5q19D', '1', '8', 'บันทึกข้อมูลการรับงาน', '2021-05-11 16:24:47', 'กราฟิก,บัญชี', '0');
...
CREATE TABLE `transport` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8 COMMENT='แผนกจัดส่ง';
...
INSERT INTO `transport` VALUES ('15', 'DyGy_kfng8CV9Jnd-DKGxK', '8', '2', '0', '2021-05-11 16:43:18', null, 'ส่งปณ.\r\n\r\nคุณกิติศักดิ์ จันทร์ถาวร\r\n315 ถ.กีฬากลาง ต.ในเมือง อ.เมือง จ.นครราชสีมา 30000\r\n0837487373', 0x68747470733A2F2F747261636B2E746861696C616E64706F73742E636F2E74682F64617368626F6172642F3F747261636B4E756D6265723D45463238313430343637305448, null);
INSERT INTO `transport` VALUES ('16', '2hhEmcmI5HiRzfrZUDbcpd', '8', '2', '0', '2021-05-11 16:41:59', null, 'จัดส่ง คุณสาวิตรี​ บาง​หลวง\r\nสำนักงาน​ส​กท.พิจิตร​ 52  ม.2  ต.ทุ่ง​น้อย​ อ.โพทะเล​ จ.พิจิตร​66130\r\nโทรศัพท์​099-4543972​', 0x206B6574682E6D652F6433313435363763, null);
INSERT INTO `transport` VALUES ('17', 'WQGXPhm9vwlsfnZA11AWaY', '8', '2', '0', '2021-05-11 16:44:56', null, 'รอที่อยู่จัดส่ง *แก้ไขอีกครั้ง ', 0x68747470733A2F2F747261636B2E746861696C616E64706F73742E636F2E74682F64617368626F6172642F3F747261636B4E756D6265723D45463238313430343934345448, null);
INSERT INTO `transport` VALUES ('18', 'ASSAjitIb9LjfuW4kfBfqk', '8', '2', '0', '2021-05-11 16:46:56', null, 'ฟอร์คอนเฮ้าส์ หจก.สำนักงานใหญ่ 29/2 หมู่11 ต.คลองห้า อ.คลองหลวง จ.ปทุมธานี 12120', 0x68747470733A2F2F747261636B2E746861696C616E64706F73742E636F2E74682F64617368626F6172642F3F747261636B4E756D6265723D45463238313430343836305448, null);
INSERT INTO `transport` VALUES ('19', 'rJAJa1zr9t8YihRUh5yKM6', '8', '2', '0', '2021-05-11 16:38:37', null, 'ร้านทำทุกอย่างดอทคอม  \r\nK เข้ม 0851003160\r\n\r\nเลขตึก  162/532  บางแคคอนโดทาวน  \r\nห้อง 168 อาคารพาณิชย์  ก่อนถึงศาลพระภูมิ  \r\nถ.เพชรเกษม   แขวงบางแคเหนือ เขตบางแค  กรุงเทพน  10160', 0x68747470733A2F2F747261636B2E746861696C616E64706F73742E636F2E74682F64617368626F6172642F3F747261636B4E756D6265723D45463238313430343831315448, null);
...
INSERT INTO `transport` VALUES ('23', 'jGzP_OORkZdjjEm2vxpLmd', null, '1', '0', null, null, null, null, null);
INSERT INTO `transport` VALUES ('24', '_kn8kDdx84Qpsh3jCEO0cP', null, '1', '0', null, null, null, null, null);
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', 'admin', 'kimniyomclub@gmail.com', '$2y$12$MenOVpHsMKOW0zYIFAD1ruqkamrLlEG1YIkcKOD9/eGmR9ECXzzsO', 'eVObZ98v26jv2RAmbdeUIlaHK4uJ8S-8', '1617557741', null, null, '::1', '1617557092', '1617557092', '0', '1620784424', 'A');
...
INSERT INTO `user` VALUES ('8', 'marketing1', 'marketing@natdesigntak.com', '$2y$12$s9nzt0ro08WKmok.HTgWIegzowEBAbE6gSwBGtp173ts28ndZ9ZJ6', 'bQYe0AA-eiJ69oCPWXDonoYYT1vbmXzY', '1620129337', null, null, '49.48.207.49', '1620129337', '1620129374', '0', '1620784069', 'U');
INSERT INTO `user` VALUES ('9', 'Accounts1', 'ac1@natdesigntak.com', '$2y$12$X5TE/UD40FwEmZj3BRjc5uypvXluCVFGXRrW1pFcsLllrPY8NRtp6', 'eKLsvIznGZzAiyFlsn6Qvds00HEQfqbM', '1620129817', null, null, '49.48.207.49', '1620129817', '1620130114', '0', '1620696367', 'U');
...
INSERT INTO `user` VALUES ('12', 'Graphic', 'graphic@natdesigntak.com', '$2y$12$N7T0Tt2c7XWS7hyxMdu5UOKKcJQe9S1lVjOpo6GafgRBD0JuDh/Oq', '3qtUEslIie7ne69JE8EVRq-vrRaQX3dl', '1620175500', null, null, '49.48.207.49', '1620175500', '1620175500', '0', '1620783764', 'U');
INSERT INTO `user` VALUES ('13', 'Printing', 'printing@natdesigntak.com', '$2y$12$dFsnaM4YK4hWmigMg7lkLON.F0GDfo8I3NDoU96PnqgsyxCbaNcOS', '4AXQJ3nEQeHgr2NJRbFDPg4bm41pGxNt', '1620175748', null, null, '49.48.207.49', '1620175748', '1620175748', '0', '1620782955', 'U');
...
INSERT INTO `user` VALUES ('16', 'Manager', 'fern.worra@gmail.com', '$2y$12$TiFEAn9cL3UakE27cnu47ekuE3AQTyWQ53Mx/mR2JDTbMYhIN87de', 'K6gJiIuWqij2QCXAMjDaoyjohdcwm6-9', '1620176182', null, null, '49.48.207.49', '1620176182', '1620176916', '0', '1620722339', 'A');
INSERT INTO `user` VALUES ('17', 'Executive', 'natmawan@gmail.com', '$2y$12$Q.0JhtSi/utLRfAoRNeLNeMOzw5pEAptnCEG34HTGdUQLpjz5jV3y', '-8BOjhYHFCiHXlkp8OJ3BHzW3fQd5mc4', '1620176380', null, null, '49.48.207.49', '1620176380', '1620185767', '0', '1620784857', 'A');
