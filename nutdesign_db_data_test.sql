...
CREATE TABLE `account` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8 COMMENT='ตารางแผนกบัญชี';
...
INSERT INTO `account` VALUES (27, NULL, 'lqPKHuXygVGDIpYsyI9kt7', NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL);
...
INSERT INTO `account` VALUES (29, NULL, 'KpZoS2n0XXjgWrCvn1MOKS', NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL);
INSERT INTO `account` VALUES (30, NULL, 'rJAJa1zr9t8YihRUh5yKM6', NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL);
INSERT INTO `account` VALUES (31, NULL, 'X77vrRC85W3ppSbUrwoP43', NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL);
INSERT INTO `account` VALUES (32, NULL, 'm0KhYK9RmwgVOGo-0MmlhG', NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL);
INSERT INTO `account` VALUES (33, NULL, 'WQGXPhm9vwlsfnZA11AWaY', NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL);
COMMIT;
...
CREATE TABLE `customer` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8 COMMENT='เก็บรายละเอียดลูกค้า / รับงาน';

-- ----------------------------
-- Records of customer
-- ----------------------------
BEGIN;
INSERT INTO `customer` VALUES (1, 'ป้ายไวนิลน้ำแข็ง', 'Fam', '0931758306', 1, 'Fam', 'จัดส่ง... รถตู้แม่สอด\r\n\r\nคุณศุทธวีร์ ที่อยุ่ 364 หมู่ที่6 ต.แม่ตาว อ.แม่สอด จ.ตาก 63110 \r\n0931758306', NULL, '<p>ป้ายไวนิล พิมพ์ 2 ด้าน ตอกไก่ 4 มุม<br>ขนาด 58x112 ซม. จำนวน 1 ชิ้นๆ ละ 350.-<br><br>ค่าส่ง 100.-<br><br>รวมยอดชำระ 450.-<br><br>---------------------------------------------------------<br><br>ข้อความว่า..<br><br>ร้านน้ำแข็ง<br>สะอาด<br>จำหน่าย<br>น้ำแข็งหลอด-บด<br>ปลีก/ส่ง รับส่งทุกงาน<br>ติดต่องาน0878472765<br> 0931758306</p>', NULL, '2021-05-06', '09:00:00', '4', NULL, '2021-05-05 09:05:20', 16, 'W_Dy_0CqF2px9NwnokjDCE', 1, 0, 0, 0, 0, 1, 0, NULL, NULL, 2, 0, 2, 0, 0, NULL);
INSERT INTO `customer` VALUES (2, '​ไวนิลในหลวงร.10 ', 'thanyaสวนป่าแม่ละเมา', '098-8262052', 1, 'thanyaสวนป่าแม่ละเมา', 'รับหน้าร้าน ', NULL, '<p>ไวนิลในหลวงร.10<br>ขนาด 100x150 cm. 1 ชิ้นๆละ 240 บาท</p>', NULL, '2021-05-05', '13:00:00', '4', NULL, '2021-05-05 09:32:04', 8, 'LpFjgcw2rQ7R8maXPwoNE6', 0, 0, 1, 0, 1, 1, 0, NULL, NULL, 2, 0, 0, 0, 0, NULL);
INSERT INTO `customer` VALUES (3, '​พลาสวูด ', 'Rungradit', '081-9868456', 1, 'Rungradit', 'จัดส่ง\r\nนายรุ่งรดิศ  วีระกุล\r\nธนาคารกรุงไทย  สาขาเมืองทองธานี ชั้น 3 เลขที่ 321 ถนนบอนด์สตรีท  ตำบลบางพูด อำเภอปากเกร็ด จังหวัดนนทบุรี 11120\r\nโทร.081-9868456', NULL, '<p>พลาสวูด กว้าง 50 ซม. ยาว 80 ซม. 1 ชิ้นๆละ 750.-<br>ค่าจัดส่ง 150.-<br><br>ยอดรวม 900.-</p>', NULL, '2021-05-07', '09:30:00', '4', NULL, '2021-05-05 09:41:16', 8, '80WMVrjv2tuVl5n9cC_CKy', 1, 0, 1, 0, 0, 1, 0, NULL, NULL, 0, 2, 2, 0, 0, NULL);
INSERT INTO `customer` VALUES (4, '​ภาพพิมพ์ยูวี', 'Bombay', '0904528488', 1, 'Bombay', 'จัดส่ง ส่งรถตู้\r\nพงษ์สิทธิ์ มาขอด ที่อยู่ 633 หมู่ 1 ต.ท่าสายลวด อ.แม่สอด จ.ตาก 63110\r\nโทร.0904528488', NULL, '<p>ภาพพิมพ์ยูวีขนาด 60x80 ซม. 1ชิ้นๆละ 890.-<br>ค่าจัดรถตู้100.-<br><br>*งานนำภาพมารวมกันใน 1 ชิ้นงาน<br>*ข้อความว่า Happy birthday dear<br>ขอให้มีความสุขมากๆ นะจ้า คิดสิ่งใดขอให้สมปรารถนา ทำอะไรก็ให้ประสบแต่ความสำเร็จ (08/05/64) Love so much<br><br>ยอดชำระรวม 990.-</p>', NULL, '2021-05-05', '13:00:00', '4', NULL, '2021-05-05 09:46:17', 8, 'Yf5vTaeciRsnZN5M-I9sLI', 1, 0, 1, 0, 0, 1, 0, NULL, NULL, 2, 2, 2, 0, 0, NULL);
INSERT INTO `customer` VALUES (5, 'พวงกุญแจอะคริลิคใส ', 'Pu.. 0939496646', '0939496646', 1, 'Pu.. 0939496646', 'คุณปู\r\nRoyal king suite\r\n159 หมู่ 7 ซอยนวมินทร 4 ตำบล บางบ่อ อำเภอบางบ่อ สมุทรปราการ 10560\r\n0939496646', NULL, '<p>พวงกุญแจอะคริลิคใส 5 มิล พิมพ์ยูวี 4 สี 1 ด้าน<br>ขนาด 4x8 ซม. พร้อมเจสะรูใส่ห่วง พร้อมจัดส่งฟรี <br>จำนวน 160 ชิ้นๆละ 40.- = 6,400.- <br>* ราคาไม่รวมภาษีมูลค่าเพิ่ม * </p>', NULL, '2021-05-07', '11:00:00', '4', NULL, '2021-05-05 09:58:15', 8, '76hIJ7ACiXmWpNWvGLspUW', 1, 0, 0, 0, 1, 1, 0, NULL, NULL, 1, 2, 2, 0, 0, NULL);
INSERT INTO `customer` VALUES (6, '​สติ๊กเกอร์ PVC', 'OEL', '061-7967260', 1, 'OEL', 'รับงานหน้าร้าน ', NULL, '<p>สติ๊กเกอร์ PVC ขนาด 80X65 ซม. ราคา 450 บาท</p><p>ค่าบริการออกแบบ ราคา 300 บาท</p><p>ค่าบริการ 750 บาท (ลูกค้าชำระเงินสดตอนรับงาน)</p>', NULL, '2021-05-06', '10:15:00', '4', NULL, '2021-05-05 10:20:16', 8, 'KINCuRWXK3PMUAOwfw0IA5', 0, 0, 0, 0, 1, 1, 0, NULL, NULL, 1, 0, 0, 0, 0, NULL);
INSERT INTO `customer` VALUES (7, '​สติ๊กเกอร์ไดคัท', 'chamook :)', '0918829905', 1, 'chamook :)', 'รับงานหน้าร้าน ', NULL, '<p>สติ๊กเกอร์ไดคัท 1 ตรม. 650.- แล้ว รับงานพรุ่งนี้ช่วงบ่าย<br><br>*ตั้งขนาดไว้ที่ กว้าง 5 ซม.เป็นหลัก ความสูงให้จัดสรรให้</p>', NULL, '2021-05-05', '10:40:00', '4', NULL, '2021-05-05 10:35:05', 8, '_TDDyi2XV9OSkAs_phSlcX', 0, 0, 1, 0, 0, 1, 0, NULL, NULL, 2, 0, 2, 0, 0, NULL);
INSERT INTO `customer` VALUES (8, 'ทดสอบส่งงานโดยณัฐพล', 'ทดสอบส่งงานโดยณัฐพล', '', 1, 'nammawan', 'ไปติดตั้งร้านกาแฟ soon cafe ริมน้ำ', NULL, '<p>เพื่อจะทดสอบว่าคนๆเดียวสามารถรับงาน / ส่งงาน ไปยังแผนกอื่นๆ ได้โดยไม่ต้องผ่านฝ่ายใดๆ</p>', NULL, '2021-05-05', '10:36:00', '4', NULL, '2021-05-05 10:40:28', 1, 'H5O9zgJoDb6GiMH_xX4mPE', 0, 1, 0, 0, 1, 1, 0, NULL, NULL, 0, 2, 0, 2, 0, NULL);
INSERT INTO `customer` VALUES (9, 'สติ๊กเกอร์ไดคัท ', 'fa', '0928166996', 1, 'fa', 'รับงานหน้าร้าน ', NULL, '<p>สติ๊กเกอร์ขนาด 10x5 ซม. จำนวน 1 ตรม. ลูกค้ารับงานหน้าร้าน 500.-<br>*โปรลดเหลือ 400.- </p>', NULL, '2021-05-05', '11:15:00', '3, 4', NULL, '2021-05-05 11:12:37', 8, 'aqoqo21ctwWwK8PhqFKfqs', 0, 0, 1, 0, 0, 1, 0, NULL, NULL, 2, 0, 0, 0, 0, NULL);
INSERT INTO `customer` VALUES (10, 'สติ๊กเกอร์ใส', 'OEL', '0617967260', 1, 'OEL', 'รับงานหน้าร้าน ', NULL, '<p>พิมพ์สติ๊กเกอร์ใส ขนาด 60x40cm = 2 ชิ้นๆละ 300.- = 600.-<br>(แบบที่ลูกค้าส่งมา) </p>', NULL, '2021-05-06', '13:00:00', '4', NULL, '2021-05-05 11:18:15', 8, '1-deFHIsDp8UH_1LfynQ33', 0, 0, 1, 0, 1, 1, 0, NULL, NULL, 2, 0, 2, 0, 0, NULL);
INSERT INTO `customer` VALUES (11, 'คอมโพสิตขาว ', 'Eubeib กาแฟ (Soon คาเฟ่)', '0850536709', 1, 'Eubeib กาแฟ (Soon คาเฟ่)', 'งานติดตั้ง', NULL, '<p>คอมโพสิตขาว 10 มิล ตีกล่อง 80x80x20 cm. + ตัวอักษรพลาสวูดทำสีเทา = 3,500.- </p>', NULL, '2021-05-07', '09:00:00', '3, 4', NULL, '2021-05-05 13:13:31', 8, 'l7bbwQI9C4UqeU9f7nnwZB', 0, 1, 1, 0, 1, 1, 0, NULL, NULL, 2, 2, 2, 0, 0, NULL);
INSERT INTO `customer` VALUES (12, 'ฉากกั้นอะคริลิคขนาด 110x60 cm. ', 'ปอนด์ ', '081-9795951', 1, 'ปอนด์ ', 'นายปอล มามะกะมูละ\r\n15/5 ตำบลขุนโขลน อำเภอพระพุทธบาท จังหวัดสระบุรี\r\n18120\r\n081-9795951', NULL, '<p>ฉากกั้นอะคริลิคขนาด 110x60 ด้านข้างซ้ายขวาฝั่งละ 30 cm. 3 ชิ้นๆละ 1,580.-<br><br>ค่าจัดส่ง 500.- (เกินนี้ทางร้านดูแลให้ค่ะ)<br><br>ยอดชำระทั้งสิ้น 5,240.-</p>', NULL, '2021-05-05', '15:00:00', '3, 4', NULL, '2021-05-05 14:21:57', 8, 'HQcTSNCNtgc3SWwo5aAeAE', 1, 0, 1, 0, 0, 1, 0, NULL, NULL, 0, 2, 2, 0, 0, NULL);
INSERT INTO `customer` VALUES (13, 'สติ๊กเกอร์ซีทรูติดกระจก + ฉากกั้นเคาน์เตอร์โฟมบอร์ด 4 มิล', 'พี่เจี๊ยบ อบตโป่งแดง', '0925565364', 1, 'พี่เจี๊ยบ อบตโป่งแดง', 'ติดตั้งงาน อบต.โป่งแดง (กองสวัสดิการสังคม)', NULL, '<p>1. ติดกระจกห้องกองสวัสดิการสังคม</p><p>สติ๊กเกอร์ซีทรู พร้อมติดตั้ง จำนวน 10 บาน</p><p>2. ฉากกั้นเคาน์เตอร์โฟมบอร์ด 4 มิล </p><p>ขนาด 150X75 ซม. จำนวน 1 ชิ้น</p><p>ขนาด 150X75 +75 ซม. จำนวน 1 ชิ้น </p><p>**แถมริ้วทองมิลเลอร์ ปิดขอบบนไปด้วย **</p><p>งานติดตั้งที่ อบต.โป่งแดง</p><p>.</p><p>อ้างอิงใบเสนอราคา QT2021050012</p>', NULL, '2021-05-07', '10:32:00', '3, 4', NULL, '2021-05-05 14:40:27', 8, 'ZevKuy2Fnz8Bmpa1RsXKSI', 0, 1, 1, 0, 1, 1, 0, NULL, NULL, 0, 0, 0, 0, 0, NULL);
INSERT INTO `customer` VALUES (14, 'สแตนดี้ฟิวส์ ', 'Cue_cue', '0819734867', 1, 'Cue_cue', 'ลูกค้ารับเองหน้าร้าน', NULL, '<p>สแตนดี้ : ฟิวเจอร์บอร์ดพิมพ์ยูวี พร้อมขาตั้ง</p><p>ขนาดรวม 70X150 ซม. จำนวน 1 ชิ้น</p><p>.</p><p>อ้างอิงใบเสนอราคา QT2021050020</p>', NULL, '2021-05-07', '10:00:00', '3, 4', NULL, '2021-05-05 16:20:06', 8, 'lER6-HE2lJwDeTY21TlJ6s', 0, 0, 1, 0, 1, 1, 0, NULL, NULL, 0, 0, 0, 0, 0, NULL);
INSERT INTO `customer` VALUES (15, 'ไวนิลพับขอบตอกไก่ 4 ด้าน ', 'AON', '0612850218', 1, 'AON', 'ลูกค้ารับงานหน้าร้าน ขอรับงาน 06/05 ก่อนเวลา 12.00 น. ', NULL, '<p>ไวนิลขนาด 220x77 ซม. 1 ป้ายๆละ 245.-<br>พับขอบเจาะรู 4 ด้าน</p>', NULL, '2021-05-05', '11:30:00', '3, 4', NULL, '2021-05-05 17:18:21', 8, 'Pel7uZlkWv70QlEM7N_lKb', 0, 0, 1, 0, 0, 1, 0, NULL, NULL, 2, 0, 1, 0, 0, NULL);
INSERT INTO `customer` VALUES (16, '​บล็อคพ่นสี', 'yai', '0851003160', 1, 'yai', 'ร้านทำทุกอย่างดอทคอม  \r\nK เข้ม 0851003160\r\n\r\nเลขตึก  162/532  บางแคคอนโดทาวน  \r\nห้อง 168 อาคารพาณิชย์  ก่อนถึงศาลพระภูมิ  \r\nถ.เพชรเกษม   แขวงบางแคเหนือ เขตบางแค  กรุงเทพน  10160', NULL, '<p>บล็อคพ่นสี ขนาด 45x16 ซม. 1 ชิ้นๆละ 350.- รวมส่ง J&amp;T<br>*ข้อมูลอยู่ในเมล์</p>', NULL, '2021-05-07', '11:00:00', '3, 4', NULL, '2021-05-05 17:21:16', 8, 'ZJpRfgA-Sg1-iQ0c_lFTPA', 1, 0, 0, 0, 0, 1, 0, NULL, NULL, 0, 2, 2, 0, 0, NULL);
INSERT INTO `customer` VALUES (17, 'Banner Stand ', 'ประภัสสร เกษตรตาก', '055 511 009', 1, 'ประภัสสร เกษตรตาก', 'สำนักงานเกษตรจังหวัดตาก', NULL, '<p>Banner Stand ขนาด 60x160 ซม. <span class=\"redactor-invisible-space\"> จำนวน 5 ป้าย</span></p><p><span class=\"redactor-invisible-space\">** ลูกค้ามีไฟล์งานให้ แต่ต้องปรับขนาดให้ได้ 60X160 ซม. **</span></p><p><span class=\"redactor-invisible-space\">.</span></p><p><span class=\"redactor-invisible-space\">อ้างอิง QT2021040102<span class=\"redactor-invisible-space\"></span></span></p>', NULL, '2021-05-07', '13:00:00', '3, 4', NULL, '2021-05-05 17:31:01', 8, '-D3HjJnBYj_bngAK3ut3Nc', 0, 0, 1, 0, 1, 1, 0, NULL, NULL, 1, 0, 1, 0, 0, NULL);
INSERT INTO `customer` VALUES (18, 'บล็อคพ่นสี', 'Fon', '0942969749', 1, 'Fon', 'น.ส.สายฝน แก้วคำภา\r\nที่อยู่ 70 หมู่11 ต.นาชุมแสง อ.ภูเวียง จ.ขอนแก่น 40150  \r\nเบอร์ 094-2969749', NULL, '<p>บล็อคพ่นสี ขนาด 40x20 cm. 1 ชิ้นๆละ 200.-<br>ค่าจัดส่งแฟลช 80.-<br><br>ยอดชำระรวม 280.-</p>', NULL, '2021-05-07', '09:00:00', '3, 4', NULL, '2021-05-06 08:48:37', 8, 'BdSi1aloNqzKqs1dRzh_Mb', 1, 0, 0, 0, 0, 1, 0, NULL, NULL, 0, 2, 1, 0, 0, NULL);
INSERT INTO `customer` VALUES (19, '​ป้ายชื่อติดอก', 'Nalina', '0872664433', 1, 'Nalina', 'จัดส่ง\r\nคุณนลินา จันทะฟอง\r\n2/44 หมู่ 1 ต.ทับปุด อ.ทับปุด จ.พังงา 82180\r\nโทร 087 2664433', NULL, '<p>ป้ายชื่อติดอก 2 ชิ้นๆละ 200.- = 400.-<br>ค่าจัดส่ง 100.-<br><br>ยอดชำระรวม 500.-<br><br>ป้ายที่1<br>นลินา จันทะฟอง<br>ประธานสภาเทศบาล<br><br>ป้ายที่2<br>ณัฐวุฒิ พุมฤทธิ์<br>รองประธานสภาเทศบาล</p>', NULL, '2021-05-08', '10:00:00', '3, 4', NULL, '2021-05-06 11:01:43', 8, '72IH6IoMq2GVAY6g6j9cWI', 1, 0, 0, 0, 0, 1, 0, NULL, NULL, 0, 0, 0, 0, 0, NULL);
INSERT INTO `customer` VALUES (20, '​X-Stand ', 'X-Stand พิซซ่าแม่สอด', '063-9054880', 1, 'X-Stand พิซซ่าแม่สอด', 'จัดส่งรถตู้แม่สอด\r\n\r\nชื่อ  Bao\r\n612/1ถ.อินทรคีรี  ต.แม่สอด  อ.แม่สอด  จ.ตาก63110(ร้านผลไม้หน้าวัดชุมพล)\r\nโทร.063-9054880 / 095-3316844', NULL, '<p>X-Stand 60x160 ซม. จำนวน 2 ชิ้นๆละ 1,100.-</p><p>รวมเป็นเงิน 2,200.-<br><br>ค่าจัดส่ง 150.-<br><br>รวมยอดชำระ 2,350.-</p>6 พ.ค. 2021 16.36 น.<span class=\"text-dark ml-2\">', NULL, '2021-05-07', '13:00:00', '3, 4', NULL, '2021-05-06 17:01:37', 8, 'JK9-EvGZcUUQ_i7KnFAycm', 1, 0, 1, 0, 0, 1, 0, NULL, NULL, 2, 0, 2, 0, 0, NULL);
INSERT INTO `customer` VALUES (21, 'ไวนิลพับขอบตอกไก่ 4 ด้าน ', 'ตากขาวละออ', '0000000000', 1, 'ตากขาวละออ', 'รับงานหน้าร้าน', NULL, '<p>ไวนิลไวนิลขนาด 220 x 150 cm<br>พับขอบตอกไก่ 4 ด้าน </p>', NULL, '2021-05-07', '16:00:00', '3, 4', NULL, '2021-05-06 17:06:16', 8, 'kLtTSk2dfLXj3wJUeKAQdV', 0, 0, 1, 0, 1, 1, 0, NULL, NULL, 2, 0, 0, 0, 0, NULL);
INSERT INTO `customer` VALUES (22, '​ป้ายคอมโพสิตทองเมทัลลิก', 'Vera Cafe’ & Gallery', '0837487373', 1, 'Vera Cafe’ & Gallery', 'ส่งปณ.\r\n\r\nคุณกิติศักดิ์ จันทร์ถาวร\r\n315 ถ.กีฬากลาง ต.ในเมือง อ.เมือง จ.นครราชสีมา 30000\r\n0837487373', NULL, '<p>ป้ายคอมโพสิตทองเมทัลลิก ขนาด 35x15 ซม. 1 ชิ้นๆละ 235.-<br>ค่าจัดส่ง 100.-<br><br>ยอดชำระรวม 335.-<br><br>* ป้ายทางออก EXIT ตามแบบ</p>', NULL, '2021-05-07', '13:00:00', '3, 4', NULL, '2021-05-07 08:54:02', 8, 'DyGy_kfng8CV9Jnd-DKGxK', 1, 0, 1, 0, 0, 1, 0, NULL, NULL, 1, 0, 0, 0, 0, NULL);
INSERT INTO `customer` VALUES (23, 'ภาพพิมพ์ยูวี', 'SIN', '0991055553', 1, 'SIN', 'รับงานหน้าร้าน ', NULL, '<p>ภาพพิมพ์ยูวี ขนาด 30x40 ซม. 1 ชิ้นๆละ 250.- (ราคาส่ง)<br>ข้อความ Happy Birthday</p>', NULL, '2021-05-08', '12:00:00', '3, 4', NULL, '2021-05-07 09:00:31', 8, 'uy0t1Xm7NfCoTw2rD1zKU9', 0, 0, 0, 0, 0, 1, 0, NULL, NULL, 2, 0, 0, 0, 0, NULL);
INSERT INTO `customer` VALUES (24, ' ป้ายชื่อติดอก', 'Nalina', '0872664433', 1, 'Nalina', 'จัดส่งปณ. \r\nคุณนลินา จันทะฟอง\r\n2/44 หมู่ 1 ต.ทับปุด อ.ทับปุด จ.พังงา 82180\r\nโทร 087 2664433', NULL, '<p>งานเพิ่ม ป้ายชื่อติดอก 2 ชิ้นๆละ 200.- <br>ยอดชำระรวม 400.-<br><br>ป้ายที่1<br>การุณ ชูสังข์<br>รองนายกเทศมนตรี<br><br>ป้ายที่2<br>อนันต์ ชูพุฒ<br>รองนายกเทศมนตรี</p>', NULL, '2021-05-08', '13:00:00', '3, 4', NULL, '2021-05-07 13:06:46', 8, '_kn8kDdx84Qpsh3jCEO0cP', 1, 0, 1, 0, 0, 1, 0, NULL, NULL, 0, 0, 0, 0, 0, NULL);
INSERT INTO `customer` VALUES (25, '​ฟิว 3 มิล พิมพ์ยูวี', 'พี่ขาว cat', '0885998536', 1, 'พี่ขาว cat', 'งานลูกค้าพี่ณัฐ *หน้าร้าน*', NULL, '<p>ฟิว 3 มิล พิมพ์ยูวี  80x40 ซม. แผ่นละ 160.-<br>- พื้นเหลือง 14 ชิ้น = 160x14 = 2,240.-<br>- พื้นขาว 13 ชิ้น = 160x13 = 2,080.-<br><br>ใบเสนอราคา QT2021050023 <a href=\"https://doc-api.flowaccount.com/quotation/share/html/th/nrv9w4f0usq3x5pyjwcyq\" target=\"_blank\" rel=\"noopener\">https://doc-api.flowaccount.com/quotation/share/html/th/nrv9w4f0usq3x5pyjwcyq</a></p>', NULL, '2021-05-10', '10:30:00', '3, 4', NULL, '2021-05-07 15:51:26', 8, 'MFzzD00Me92O7h2Jy0vzHu', 0, 0, 0, 0, 1, 1, 0, NULL, NULL, 0, 0, 0, 0, 0, NULL);
INSERT INTO `customer` VALUES (26, 'ภาพพิมพ์ยูวี', 'SA  Bl', '099-4543972​', 1, 'SA  Bl', 'จัดส่ง คุณสาวิตรี​ บาง​หลวง\r\nสำนักงาน​ส​กท.พิจิตร​ 52  ม.2  ต.ทุ่ง​น้อย​ อ.โพทะเล​ จ.พิจิตร​66130\r\nโทรศัพท์​099-4543972​', NULL, '<p>ภาพพิมพ์ยูวี ขนาด 20x30 ซม. 2 ชิ้นๆละ 260.- (ราคาลด10%จาก290.-)<br>ค่าจัดส่ง 200.-<br><br>ยอดชำระทั้งสิ้น 720.-</p>', NULL, '2021-05-08', '14:00:00', '3, 4', NULL, '2021-05-07 16:24:13', 8, '2hhEmcmI5HiRzfrZUDbcpd', 1, 0, 1, 0, 0, 1, 0, NULL, NULL, 0, 0, 0, 0, 0, NULL);
INSERT INTO `customer` VALUES (27, 'สติ๊กเกอร์ติดรถ', 'fat boy ', '-', 4, 'ลูกค้าพี่ณัฐ ', 'ลูกค้าพี่ณัฐ ', NULL, '<p>สติ๊กเกอร์ติดรถ (สีแดง) </p><p>*** เพิ่มเติมสอบถามพี่ณัฐค่ะ ***</p>', NULL, '2021-05-10', '10:00:00', '3, 4', NULL, '2021-05-07 16:55:11', 8, 'lqPKHuXygVGDIpYsyI9kt7', 0, 1, 1, 0, 0, 1, 0, NULL, NULL, 0, 0, 0, 0, 0, NULL);
INSERT INTO `customer` VALUES (28, 'คอมโพสิตขาวพิมพ์ยูวี ติดตัวอักษรอะคริลิค', 'จัดซื้อPDK', '082-5239080', 1, 'จัดซื้อPDK', '29/1 หมู่11 ต.คลองห้า อ.คลองหลวง จ.ปทุมธานี', NULL, '<p>คอมโพสิตขาวพิมพ์ยูวี ติดตัวอักษรอะคริลิค สีตามแบบ + หมุดปิดหัว 6 ตัว/ชุด<br>ป้ายขนาด 240x50 ซม. = 3,000.- <br>ค่าจัดส่ง 800.- </p><p><br></p>', NULL, '2021-05-10', '11:00:00', '3, 4', NULL, '2021-05-07 17:11:07', 8, 'kUH617ueCSMo-_c7ONrmLW', 1, 0, 0, 0, 0, 1, 0, NULL, NULL, 0, 0, 0, 0, 0, NULL);
INSERT INTO `customer` VALUES (29, '​ภาพพิมพ์ยูวี', 'SIN', '0620363521', 1, 'SIN', '* รับงานหน้าร้าน ', NULL, '<p>ภาพพิมพ์ยูวี ขนาด 40x50 ซม. 1 ชิ้นๆละ 450.- (ราคาส่ง)<br><br>รายละเอียดงาน<br>-ขนาด 40x50<br>-เพลงแค่เธอเข้ามาของ tilly bird (ใช้คิวอาร์โค้ด joox)<br>-ข้อความไม่มี</p>', NULL, '2021-05-10', '11:30:00', '3, 4', NULL, '2021-05-08 09:06:31', 8, 'KpZoS2n0XXjgWrCvn1MOKS', 0, 0, 0, 0, 0, 1, 0, NULL, NULL, 0, 0, 0, 0, 0, NULL);
INSERT INTO `customer` VALUES (30, 'บล็อคพ่นสี', 'yai', ' 0851003160', 1, 'yai', 'ร้านทำทุกอย่างดอทคอม  \r\nK เข้ม 0851003160\r\n\r\nเลขตึก  162/532  บางแคคอนโดทาวน  \r\nห้อง 168 อาคารพาณิชย์  ก่อนถึงศาลพระภูมิ  \r\nถ.เพชรเกษม   แขวงบางแคเหนือ เขตบางแค  กรุงเทพน  10160', NULL, '<p>บล็อคพ่นสี ขนาด A4 1 ชิ้นๆละ 320.- รวมส่ง</p><p>*ข้อมูลอยู่ในเมล์</p>8 พ.ค. 2021 9.08 น.<span class=\"text-dark ml-2\">', NULL, '2021-05-10', '10:00:00', '3, 4', NULL, '2021-05-08 09:08:49', 8, 'rJAJa1zr9t8YihRUh5yKM6', 1, 0, 0, 0, 0, 1, 0, NULL, NULL, 0, 0, 0, 0, 0, NULL);
INSERT INTO `customer` VALUES (31, 'สติ๊กเกอร์ฝ้า', 'kanjanun', '0882933687', 1, 'kanjanun', '* รับงานหน้าร้าน ', NULL, '<p>เพิ่มงานสติ๊กเกอร์ฝ้า 1 ชิ้น *แก้ไขที่อยู่ </p>', NULL, '2021-05-10', '10:00:00', '3, 4', NULL, '2021-05-08 10:10:11', 8, 'X77vrRC85W3ppSbUrwoP43', 0, 0, 0, 0, 1, 1, 0, NULL, NULL, 0, 0, 0, 0, 0, NULL);
INSERT INTO `customer` VALUES (32, 'ภาพพิมพ์ยูวี', 'พี่บัญชา นายกโบ๊ท', '-', 4, '-', '* รับงานหน้าร้าน ', NULL, '<p>ภาพพิมพ์ยูวี 40x60 ซม.<br>*เปลี่ยนพื้นหลังเป็นสีน้ำเงิน<br><br>*งานฟรีพี่เฟิร์นไม่คิดเงิน</p>', NULL, '2021-05-10', '10:10:00', '3, 4', NULL, '2021-05-08 10:11:42', 8, 'm0KhYK9RmwgVOGo-0MmlhG', 0, 0, 0, 0, 0, 1, 0, NULL, NULL, 0, 0, 0, 0, 0, NULL);
INSERT INTO `customer` VALUES (33, 'ป้ายอะคริลิคสีขาว', 'Alis Passapan', '083-335 8899', 1, 'Alis Passapan', 'รอที่อยู่จัดส่ง *แก้ไขอีกครั้ง ', NULL, '<p>ป้ายอะคริลิคสีขาวขนาด 45x30 ซม. 1 ชิ้นๆละ 850.- รวมจัดส่ง<br>น็อตลอย 2 ตัวๆละ 40.-<br><br>ยอดชำระทั้ง 930.-</p>', NULL, '2021-05-10', '11:00:00', '3, 4', NULL, '2021-05-08 13:54:40', 8, 'WQGXPhm9vwlsfnZA11AWaY', 1, 0, 0, 0, 0, 1, 0, NULL, NULL, 0, 0, 0, 0, 0, NULL);
COMMIT;
...
CREATE TABLE `graphic` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8 COMMENT='ตารางแผนกกราฟิก';
...
CREATE TABLE `timeline` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=169 DEFAULT CHARSET=utf8 COMMENT='ตารางเก็บประวัติการทำงาน';
