...
CREATE TABLE `account` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=48 DEFAULT CHARSET=utf8 COMMENT='ตารางแผนกบัญชี';
...
CREATE TABLE `customer` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=utf8 COMMENT='เก็บรายละเอียดลูกค้า / รับงาน';
...
INSERT INTO `customer` VALUES ('50', 'ส่งซัพผลิต', 'ณัฐดีไซน์', '0654944505', '3', '-', '', null, '', null, '2021-05-11', '15:57:00', '3', null, '2021-05-11 15:59:15', '1', 'jGzP_OORkZdjjEm2vxpLmd', '1', '1', '0', '0', '0', '1', '1', null, null, '0', '0', '0', '1', '1', '1', null, null, '4', '1');
...
CREATE TABLE `graphic` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=utf8 COMMENT='ตารางแผนกกราฟิก';
...
INSERT INTO `queue` VALUES ('10', 'jGzP_OORkZdjjEm2vxpLmd', '1', '2021-05-12', '16:01:00', '1', '1', '2021-05-11 16:02:10', '1', '', '-jIMYbHbkRI5U6A9qlkgG_');
INSERT INTO `queue` VALUES ('11', 'ZevKuy2Fnz8Bmpa1RsXKSI', null, null, null, '0', '0', null, null, null, null);
...
CREATE TABLE `timeline` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=339 DEFAULT CHARSET=utf8 COMMENT='ตารางเก็บประวัติการทำงาน';
...
INSERT INTO `transport` VALUES ('12', 'BdSi1aloNqzKqs1dRzh_Mb', '8', '2', '0', '2021-05-11 16:39:59', null, 'น.ส.สายฝน แก้วคำภา\r\nที่อยู่ 70 หมู่11 ต.นาชุมแสง อ.ภูเวียง จ.ขอนแก่น 40150  \r\nเบอร์ 094-2969749', 0x68747470733A2F2F747261636B2E746861696C616E64706F73742E636F2E74682F64617368626F6172642F3F747261636B4E756D6265723D45463238313430343736385448);
INSERT INTO `transport` VALUES ('13', 'ZJpRfgA-Sg1-iQ0c_lFTPA', '8', '2', '0', '2021-05-11 16:38:12', null, 'ร้านทำทุกอย่างดอทคอม  \r\nK เข้ม 0851003160\r\n\r\nเลขตึก  162/532  บางแคคอนโดทาวน  \r\nห้อง 168 อาคารพาณิชย์  ก่อนถึงศาลพระภูมิ  \r\nถ.เพชรเกษม   แขวงบางแคเหนือ เขตบางแค  กรุงเทพน  10160', 0x68747470733A2F2F747261636B2E746861696C616E64706F73742E636F2E74682F64617368626F6172642F3F747261636B4E756D6265723D45463238313430343831315448);
...
INSERT INTO `transport` VALUES ('15', 'DyGy_kfng8CV9Jnd-DKGxK', '8', '2', '0', '2021-05-11 16:43:18', null, 'ส่งปณ.\r\n\r\nคุณกิติศักดิ์ จันทร์ถาวร\r\n315 ถ.กีฬากลาง ต.ในเมือง อ.เมือง จ.นครราชสีมา 30000\r\n0837487373', 0x68747470733A2F2F747261636B2E746861696C616E64706F73742E636F2E74682F64617368626F6172642F3F747261636B4E756D6265723D45463238313430343637305448);
INSERT INTO `transport` VALUES ('16', '2hhEmcmI5HiRzfrZUDbcpd', '8', '2', '0', '2021-05-11 16:41:59', null, 'จัดส่ง คุณสาวิตรี​ บาง​หลวง\r\nสำนักงาน​ส​กท.พิจิตร​ 52  ม.2  ต.ทุ่ง​น้อย​ อ.โพทะเล​ จ.พิจิตร​66130\r\nโทรศัพท์​099-4543972​', 0x206B6574682E6D652F6433313435363763);
INSERT INTO `transport` VALUES ('17', 'WQGXPhm9vwlsfnZA11AWaY', '8', '2', '0', '2021-05-11 16:44:56', null, 'รอที่อยู่จัดส่ง *แก้ไขอีกครั้ง ', 0x68747470733A2F2F747261636B2E746861696C616E64706F73742E636F2E74682F64617368626F6172642F3F747261636B4E756D6265723D45463238313430343934345448);
...
INSERT INTO `transport` VALUES ('20', 'ceO-2fQclNvEJwDd4S7jIy', null, '1', '0', null, null, null, null);
INSERT INTO `transport` VALUES ('21', 'XMXoW-yaSzIWCiUTtjiXFW', null, '1', '0', null, null, null, null);
INSERT INTO `transport` VALUES ('22', 'u7i2Oit-QdjVBf26oA2LM5', null, '1', '0', null, null, null, null);
INSERT INTO `transport` VALUES ('23', 'jGzP_OORkZdjjEm2vxpLmd', null, '1', '0', null, null, null, null);
INSERT INTO `transport` VALUES ('24', '_kn8kDdx84Qpsh3jCEO0cP', null, '1', '0', null, null, null, null);
INSERT INTO `transport` VALUES ('25', 'EHtNT9tpNc1i28UkoTlfXb', null, '1', '0', null, null, null, null);
INSERT INTO `transport` VALUES ('27', '0a4gSaSnJl_Hz8SJsWjb2G', null, '1', '0', null, null, null, null);
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', 'admin', 'kimniyomclub@gmail.com', '$2y$12$MenOVpHsMKOW0zYIFAD1ruqkamrLlEG1YIkcKOD9/eGmR9ECXzzsO', 'eVObZ98v26jv2RAmbdeUIlaHK4uJ8S-8', '1617557741', null, null, '::1', '1617557092', '1617557092', '0', '1620735407', 'A');
...
INSERT INTO `user` VALUES ('8', 'marketing1', 'marketing@natdesigntak.com', '$2y$12$s9nzt0ro08WKmok.HTgWIegzowEBAbE6gSwBGtp173ts28ndZ9ZJ6', 'bQYe0AA-eiJ69oCPWXDonoYYT1vbmXzY', '1620129337', null, null, '49.48.207.49', '1620129337', '1620129374', '0', '1620712997', 'U');
...
INSERT INTO `user` VALUES ('12', 'Graphic', 'graphic@natdesigntak.com', '$2y$12$N7T0Tt2c7XWS7hyxMdu5UOKKcJQe9S1lVjOpo6GafgRBD0JuDh/Oq', '3qtUEslIie7ne69JE8EVRq-vrRaQX3dl', '1620175500', null, null, '49.48.207.49', '1620175500', '1620175500', '0', '1620727010', 'U');
INSERT INTO `user` VALUES ('13', 'Printing', 'printing@natdesigntak.com', '$2y$12$dFsnaM4YK4hWmigMg7lkLON.F0GDfo8I3NDoU96PnqgsyxCbaNcOS', '4AXQJ3nEQeHgr2NJRbFDPg4bm41pGxNt', '1620175748', null, null, '49.48.207.49', '1620175748', '1620175748', '0', '1620729721', 'U');
...
INSERT INTO `user` VALUES ('17', 'Executive', 'natmawan@gmail.com', '$2y$12$Q.0JhtSi/utLRfAoRNeLNeMOzw5pEAptnCEG34HTGdUQLpjz5jV3y', '-8BOjhYHFCiHXlkp8OJ3BHzW3fQd5mc4', '1620176380', null, null, '49.48.207.49', '1620176380', '1620185767', '0', '1620737011', 'A');
